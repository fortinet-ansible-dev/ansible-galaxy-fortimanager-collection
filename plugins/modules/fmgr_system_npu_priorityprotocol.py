...
DOCUMENTATION = '''
---
module: fmgr_system_npu_priorityprotocol
short_description: Configure NPU priority protocol.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure NPU priority protocol.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/system/npu/priority-protocol/{priority-protocol}',
        '/pm/config/global/obj/system/npu/priority-protocol/{priority-protocol}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_priorityprotocol'),
