...
def main():
    rename_metadata = {
        ...
        'dynamic_virtualwanlink_members_dynamicmapping': {
            ...
            'mkey': 'complex:{{module}}["_scope"][0]["name"]+"/"+{{module}}["_scope"][0]["vdom"]', 'v_range': [['6.0.0', '6.4.15']]
        },
        'dynamic_virtualwanlink_neighbor': {
        ...
        'firewall_internetserviceextension_disableentry': {
            'params': ['adom', 'internet-service-extension', 'disable-entry'],
            'urls': [
        ...
        'firewall_internetserviceextension_disableentry_ip6range': {
            'params': ['adom', 'internet-service-extension', 'disable-entry', 'ip6-range'],
            'urls': [
        ...
        'firewall_internetserviceextension_disableentry_iprange': {
            'params': ['adom', 'internet-service-extension', 'disable-entry', 'ip-range'],
            'urls': [
        ...
        'firewall_internetserviceextension_disableentry_portrange': {
            'params': ['adom', 'internet-service-extension', 'disable-entry', 'port-range'],
            'urls': [
        ...
        'firewall_internetserviceextension_entry': {
            'params': ['adom', 'internet-service-extension', 'entry'],
            'urls': [
        ...
        'firewall_internetserviceextension_entry_portrange': {
            'params': ['adom', 'internet-service-extension', 'entry', 'port-range'],
            'urls': [
        ...
        'firewall_ippoolgrp': {
            'params': ['adom', 'ippool_grp', 'ippool-grp'],
            'urls': [
        ...
        'firewall_proxyaddress6_headergroup': {
            'params': ['adom', 'proxy-address6', 'header-group'],
            'urls': [
        ...
        'firewall_shapingprofile_classes': {
            'params': ['adom', 'shaping-profile', 'classes'],
            'urls': [
        ...
        'system_admin_user_adomexclude': {
            ...
            'mkey': 'adom-name', 'v_range': [['6.0.0', '7.0.2']]
        },
        'system_admin_user_appfilter': {
        ...
        'system_admin_user_restrictdevvdom': {
            ...
            'mkey': 'dev-vdom', 'v_range': [['6.0.0', '6.2.3'], ['6.4.0', '6.4.0']]
        },
        'system_admin_user_webfilter': {
        ...
        'system_interface_member': {
            ...
            'mkey': 'interface-name', 'v_range': [['7.2.0', '']]
        },
        'system_localinpolicy': {
        ...
        'system_log_devicedisable': {
            ...
            'mkey': 'id', 'v_range': [['6.4.4', '7.4.6'], ['7.6.0', '7.6.2']]
        },
        'system_log_deviceselector': {
            ...
            'mkey': 'id', 'v_range': [['7.4.7', '7.4.8'], ['7.6.3', '']]
        },
        'system_log_maildomain': {
            'params': ['mail-domain'],
            'urls': [
        ...
        'telemetrycontroller_profile_application': {
            'params': ['adom', 'profile', 'application'],
            'urls': [
        ...
        'user_device_dynamicmapping': {
            ...
            'mkey': 'complex:{{module}}["_scope"][0]["name"]+"/"+{{module}}["_scope"][0]["vdom"]', 'v_range': [['6.0.0', '7.2.5'], ['7.4.0', '7.4.2']]
        },
        'user_device_tagging': {
        ...
        'user_devicegroup_dynamicmapping': {
            ...
            'mkey': 'complex:{{module}}["_scope"][0]["name"]+"/"+{{module}}["_scope"][0]["vdom"]', 'v_range': [['6.0.0', '7.2.1']]
        },
        'user_devicegroup_tagging': {
        ...
        'vpn_ipsec_phase1_ipv4excluderange': {
            'params': ['adom', 'phase1', 'ipv4-exclude-range'],
            'urls': [
        ...
        'vpn_ipsec_phase1_ipv6excluderange': {
            'params': ['adom', 'phase1', 'ipv6-exclude-range'],
            'urls': [
        ...
        'webproxy_redirectprofile_entries': {
            'params': ['adom', 'redirect-profile', 'entries'],
            'urls': [
        ...
        'ztna_webportalbookmark_bookmarks': {
            'params': ['adom', 'web-portal-bookmark', 'bookmarks'],
            'urls': [
        ...
        'ztna_webproxy_apigateway': {
            'params': ['adom', 'web-proxy', 'api-gateway'],
            'urls': [
        ...
        'ztna_webproxy_apigateway6': {
            'params': ['adom', 'web-proxy', 'api-gateway6'],
            'urls': [
        ...
        'ztna_webproxy_apigateway6_realservers': {
            'params': ['adom', 'web-proxy', 'api-gateway6', 'realservers'],
            'urls': [
        ...
        'ztna_webproxy_apigateway_realservers': {
            'params': ['adom', 'web-proxy', 'api-gateway', 'realservers'],
            'urls': [
    ...
    fmgr = NAPIManager('rename', rename_metadata, None, None, None, module, connection)
    fmgr.process_task()
