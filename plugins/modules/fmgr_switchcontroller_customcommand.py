...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_customcommand
...
options:
    ...
    switchcontroller_customcommand:
        ...
        suboptions:
            ...
            command-name:
                type: str
                description: Deprecated, please rename it to command_name. Command name called by the FortiGate switch controller in the execute command.
            description:
                type: str
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_customcommand': {
            ...
            'v_range': [['7.0.0', '']],
            'options': {
                'command': {'v_range': [['7.0.0', '']], 'type': 'str'},
                'command-name': {'v_range': [['7.0.0', '']], 'type': 'str'},
