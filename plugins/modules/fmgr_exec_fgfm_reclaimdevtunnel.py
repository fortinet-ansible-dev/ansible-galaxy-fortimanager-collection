...
DOCUMENTATION = '''
---
module: fmgr_exec_fgfm_reclaimdevtunnel
short_description: Reclaim management tunnel to device.<br/><br/>Request without device name specified will reclaim tunnels for all managed devices.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'exec_fgfm_reclaimdevtunnel'),
