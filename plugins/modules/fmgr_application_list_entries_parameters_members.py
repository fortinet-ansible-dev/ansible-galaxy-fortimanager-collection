...
DOCUMENTATION = '''
---
module: fmgr_application_list_entries_parameters_members
short_description: Parameter tuple members.
description:
...
options:
    ...
    entries:
        ...
        required: true
    parameters:
        description: The parameter (parameters) in requested url.
        type: str
        required: true
...
def main():
    ...
    url_params = ['adom', 'list', 'entries', 'parameters']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'list': {'required': True, 'type': 'str'},
        'entries': {'required': True, 'type': 'str'},
        'parameters': {'required': True, 'type': 'str'},
        'application_list_entries_parameters_members': {
            'type': 'dict',
            'v_range': [['6.4.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'application_list_entries_parameters_members'),
