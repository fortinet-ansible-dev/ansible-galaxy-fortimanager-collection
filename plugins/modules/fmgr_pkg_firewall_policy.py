        ...
        api_tag0:
            data:
                -
                    ...
                    learning-mode:
                        type: str
                        description: 'Enable to allow everything, but log all of the meaningful data for security information gathering. A learning report w...'
                        choices:
                            - 'disable'
                            - 'enable'
                    logtraffic:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/policy'
return_of_api_category_0:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               learning-mode:
                  type: str
                  description: 'Enable to allow everything, but log all of the meaningful data for security information gathering. A learning report will be...'
               logtraffic:
                  type: str
                  description: 'Enable or disable logging. Log all sessions or security profile sessions.'
               logtraffic-start:
