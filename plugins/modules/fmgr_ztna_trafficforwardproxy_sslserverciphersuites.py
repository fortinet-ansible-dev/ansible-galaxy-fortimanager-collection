...
DOCUMENTATION = '''
---
module: fmgr_ztna_trafficforwardproxy_sslserverciphersuites
short_description: Ztna traffic forward proxy ssl server cipher suites
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Ztna traffic forward proxy ssl server cipher suites
      fortinet.fortimanager.fmgr_ztna_trafficforwardproxy_sslserverciphersuites:
...
def main():
    ...
    url_params = ['adom', 'traffic-forward-proxy']
