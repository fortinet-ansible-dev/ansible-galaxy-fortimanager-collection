...
DOCUMENTATION = '''
---
module: fmgr_system_npu_ipreassembly
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IP reassebmly engine configuration.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/system/npu/ip-reassembly/{ip-reassembly}',
        '/pm/config/global/obj/system/npu/ip-reassembly/{ip-reassembly}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_ipreassembly'),
