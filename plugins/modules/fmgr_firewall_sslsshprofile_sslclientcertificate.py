...
DOCUMENTATION = '''
---
module: fmgr_firewall_sslsshprofile_sslclientcertificate
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Firewall ssl ssh profile ssl client certificate
      fortinet.fortimanager.fmgr_firewall_sslsshprofile_sslclientcertificate:
        ...
        firewall_sslsshprofile_sslclientcertificate:
          # caname: <list or string>
          # cert: <list or string>
          # keyring_list: <list or string>
          # status: <value in [do-not-offer, keyring-list, ca-sign, ...]>
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_sslsshprofile_sslclientcertificate'),
