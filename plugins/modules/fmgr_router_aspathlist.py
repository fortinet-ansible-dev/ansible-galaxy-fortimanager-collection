...
DOCUMENTATION = '''
---
module: fmgr_router_aspathlist
short_description: Configure Autonomous System
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_aspathlist'),
