...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_paramlength
short_description: Maximum length of parameter in URL, HTTP POST request or HTTP body.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/param-length/{param-length}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/param-length/{param-length}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_paramlength'),
