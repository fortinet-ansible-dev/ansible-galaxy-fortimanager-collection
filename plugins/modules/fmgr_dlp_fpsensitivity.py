...
def main():
    ...
    module_arg_spec = {
        ...
        'dlp_fpsensitivity': {
            'type': 'dict',
            'v_range': [['6.0.0', '7.2.1']],
            'options': {'name': {'v_range': [['6.0.0', '7.2.1']], 'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dlp_fpsensitivity'),
