...
DOCUMENTATION = '''
---
module: fmgr_dvm_cmd_changehaseq
short_description: Modify HA sequence to promote a slave to become the master of the cluster.
description:
...
options:
    ...
    dvm_cmd_changehaseq:
        ...
        suboptions:
            ...
            device:
                type: str
                description: 'Name or ID of the target HA cluster (original master device).'
            flags:
            ...
            new_master:
                type: str
                description: 'Name or ID of the new HA master.'
...
def main():
    ...
    perobject_jrpc_urls = [
        '/dvm/cmd/change-ha-seq/{change-ha-seq}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dvm_cmd_changehaseq'),
