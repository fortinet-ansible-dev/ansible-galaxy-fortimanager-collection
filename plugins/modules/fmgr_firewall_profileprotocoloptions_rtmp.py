...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: RTMP.
      fortinet.fortimanager.fmgr_firewall_profileprotocoloptions_rtmp:
        ...
        firewall_profileprotocoloptions_rtmp:
          # http_tunnel: <value in [disable, enable]>
          # ports: <list or integer>
          # rtmpt: <value in [disable, enable]>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_rtmp'),
