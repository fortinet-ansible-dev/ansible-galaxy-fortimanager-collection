...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/_meta_fields/firewall/policy/{policy}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_metafields_firewall_policy'),
