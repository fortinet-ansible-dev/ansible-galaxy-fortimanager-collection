...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_addresslist
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/address-list/{address-list}',
        '/pm/config/global/obj/waf/profile/{profile}/address-list/{address-list}'
    ]
    ...
    module_arg_spec = {
        ...
        'waf_profile_addresslist': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'blocked-address': {'type': 'raw'},
                'blocked-log': {'choices': ['disable', 'enable'], 'type': 'str'},
                'severity': {'choices': ['low', 'medium', 'high'], 'type': 'str'},
                'status': {'choices': ['disable', 'enable'], 'type': 'str'},
                'trusted-address': {'type': 'raw'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_addresslist'),
