...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_maxurlparam
short_description: Maximum number of parameters in URL.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/max-url-param/{max-url-param}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/max-url-param/{max-url-param}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_maxurlparam'),
