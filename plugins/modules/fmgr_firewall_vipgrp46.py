...
DOCUMENTATION = '''
---
module: fmgr_firewall_vipgrp46
short_description: Configure IPv4 to IPv6 virtual IP groups.
description:
...
EXAMPLES = '''
 ...
 - name: gathering fortimanager facts
   ...
   vars:
     ...
     ansible_httpapi_port: 443
   tasks:
    - name: retrieve all the IPv4 to IPv6 virtual IP groups
      fmgr_fact:
        facts:
            selector: 'firewall_vipgrp46'
            params:
                adom: 'ansible'
                vipgrp46: ''
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_vipgrp46'),
