...
DOCUMENTATION = '''
---
module: fmgr_user_devicecategory
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the device categories
...
def main():
    ...
    module_arg_spec = {
        ...
        'user_devicecategory': {
            ...
            'options': {
                ...
                'desc': {'v_range': [['6.0.0', '7.2.1']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_devicecategory'),
