...
DOCUMENTATION = '''
---
module: fmgr_firewall_networkservicedynamic
short_description: Configure Dynamic Network Services.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_networkservicedynamic'),
