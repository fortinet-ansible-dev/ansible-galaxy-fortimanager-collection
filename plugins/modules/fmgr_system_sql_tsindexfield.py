...
DOCUMENTATION = '''
---
module: fmgr_system_sql_tsindexfield
short_description: List of SQL text search index fields.
description:
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the SQL text search index fields
...
def main():
    ...
    module_arg_spec = {
        'system_sql_tsindexfield': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'category': {'type': 'str'}, 'value': {'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sql_tsindexfield'),
