...
options:
    ...
    user_pxgrid:
        ...
        suboptions:
            ...
            client-cert:
                type: str
                description: Deprecated, please rename it to client_cert. Client cert.
            name:
                type: str
                description: Name.
                required: true
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_pxgrid'),
