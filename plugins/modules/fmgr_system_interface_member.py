...
DOCUMENTATION = '''
---
module: fmgr_system_interface_member
short_description: Physical interfaces that belong to the aggregate or redundant interface.
description:
...
def main():
    ...
    module_primary_key = 'interface-name'
    module_arg_spec = {
        'interface': {'required': True, 'type': 'str'},
        'system_interface_member': {
            'type': 'dict',
            'v_range': [['7.2.0', '']],
            'options': {'interface-name': {'v_range': [['7.2.0', '']], 'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_member'),
