...
DOCUMENTATION = '''
---
module: fmgr_system_admin_profile_writepasswdprofiles
short_description: Profile list.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_profile_writepasswdprofiles'),
