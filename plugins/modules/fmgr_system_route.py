...
def main():
    ...
    module_arg_spec = {
        'system_route': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'device': {'type': 'str'}, 'dst': {'type': 'str'}, 'gateway': {'type': 'str'}, 'seq_num': {'required': True, 'type': 'int'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_route'),
