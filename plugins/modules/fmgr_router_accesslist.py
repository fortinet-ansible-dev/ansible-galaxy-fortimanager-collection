...
DOCUMENTATION = '''
---
module: fmgr_router_accesslist
short_description: Configure access lists.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_accesslist'),
