...
DOCUMENTATION = '''
---
module: fmgr_videofilter_keyword
short_description: Configure video filter keywords.
description:
        ...
        suboptions:
            ...
            word:
                ...
                suboptions:
                    ...
                    pattern-type:
                        type: str
                        description: Deprecated, please rename it to pattern_type. Pattern type.
                        choices:
                            - 'wildcard'
                            - 'regex'
                    status:
...
def main():
    ...
    module_arg_spec = {
        ...
        'videofilter_keyword': {
            ...
            'options': {
                ...
                'match': {'v_range': [['7.4.2', '']], 'choices': ['or', 'and'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'videofilter_keyword'),
