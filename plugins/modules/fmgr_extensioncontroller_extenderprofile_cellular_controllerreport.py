...
DOCUMENTATION = '''
---
module: fmgr_extensioncontroller_extenderprofile_cellular_controllerreport
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/extension-controller/extender-profile/{extender-profile}/cellular/controller-report/{controller-report}',
        '/pm/config/global/obj/extension-controller/extender-profile/{extender-profile}/cellular/controller-report/{controller-report}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extensioncontroller_extenderprofile_cellular_controllerreport'),
