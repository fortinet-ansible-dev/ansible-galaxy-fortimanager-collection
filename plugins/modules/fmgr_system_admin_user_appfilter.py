...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_appfilter
short_description: App filter.
description:
...
def main():
    ...
    url_params = ['user']
    module_primary_key = 'app-filter-name'
    module_arg_spec = {
        'user': {'required': True, 'type': 'str'},
        'system_admin_user_appfilter': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'app-filter-name': {'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_appfilter'),
