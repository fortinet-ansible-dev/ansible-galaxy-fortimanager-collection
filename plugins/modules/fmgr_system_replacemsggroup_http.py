...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_http
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the HTTPs of replacement message group
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "system_replacemsggroup_http"
          params:
            adom: "ansible"
            replacemsg-group: "ansible-test" # name
            http: "your_value"
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_http'),
