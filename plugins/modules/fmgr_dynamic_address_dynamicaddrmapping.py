...
def main():
    ...
    module_arg_spec = {
        ...
        'dynamic_address_dynamicaddrmapping': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'addr': {'type': 'str'}, 'id': {'required': True, 'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_address_dynamicaddrmapping'),
