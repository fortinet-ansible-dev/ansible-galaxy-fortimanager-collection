...
DOCUMENTATION = '''
---
module: fmgr_system_customlanguage
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_customlanguage': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'comments': {'type': 'str'}, 'filename': {'type': 'str'}, 'name': {'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_customlanguage'),
