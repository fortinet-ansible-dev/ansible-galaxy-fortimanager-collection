    ...
    - name: Configure predefined data type used by DLP blocking.
      fmgr_dlp_datatype:
         ...
         dlp_datatype:
            ...
            look-ahead: <value of integer>
            look-back: <value of integer>
            name: <value of string>
            pattern: <value of string>
            transform: <value of string>
            verify: <value of string>
            verify-transformed-pattern: <value in [disable, enable]>
            match-around: <value of string>
