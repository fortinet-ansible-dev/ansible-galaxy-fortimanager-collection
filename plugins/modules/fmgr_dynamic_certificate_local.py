        ...
        suboptions:
            ...
            dynamic_mapping:
                ...
                suboptions:
                    ...
                    local-cert:
                        type: str
                        description: Deprecated, please rename it to local_cert. Local cert.
            name:
                type: str
                description: Name.
                required: true
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_certificate_local'),
