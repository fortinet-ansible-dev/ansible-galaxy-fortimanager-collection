...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_proxypolicy_sectionvalue
...
def main():
    ...
    url_params = ['adom', 'pkg', 'proxy-policy']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_proxypolicy_sectionvalue'),
