...
DOCUMENTATION = '''
---
module: fmgr_application_internetservice_entry
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'application_internetservice_entry'),
