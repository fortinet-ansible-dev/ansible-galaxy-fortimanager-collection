...
options:
    ...
    firewall_shaper_trafficshaper:
        ...
        suboptions:
            bandwidth-unit:
                type: str
                description: Deprecated, please rename it to bandwidth_unit. Unit of measurement for guaranteed and maximum bandwidth for this shaper
                choices:
                    - 'kbps'
                    - 'mbps'
                    - 'gbps'
            ...
            guaranteed-bandwidth:
                type: int
                description: Deprecated, please rename it to guaranteed_bandwidth. Amount of bandwidth guaranteed for this shaper
            maximum-bandwidth:
                type: int
                description: Deprecated, please rename it to maximum_bandwidth. Upper bandwidth limit enforced by this shaper
            name:
                type: str
            ...
            per-policy:
                type: str
                description: Deprecated, please rename it to per_policy. Enable/disable applying a separate shaper for each policy.
                choices:
                    - 'disable'
                    - 'enable'
            priority:
            ...
            dscp-marking-method:
                type: str
                description: Deprecated, please rename it to dscp_marking_method. Select DSCP marking method.
                choices:
                    - 'multi-stage'
                    - 'static'
            exceed-bandwidth:
                type: int
                description: Deprecated, please rename it to exceed_bandwidth. Exceed bandwidth used for DSCP multi-stage marking.
            exceed-class-id:
                type: int
                description: Deprecated, please rename it to exceed_class_id. Class ID for traffic in [guaranteed-bandwidth, maximum-bandwidth].
            exceed-dscp:
                type: str
                description: Deprecated, please rename it to exceed_dscp. DSCP mark for traffic in [guaranteed-bandwidth, exceed-bandwidth].
            maximum-dscp:
                type: str
                description: Deprecated, please rename it to maximum_dscp. DSCP mark for traffic in [exceed-bandwidth, maximum-bandwidth].
            overhead:
                type: int
            ...
            cos-marking:
                type: str
                description: Deprecated, please rename it to cos_marking. Enable/disable VLAN CoS marking.
                choices:
                    - 'disable'
                    - 'enable'
            cos-marking-method:
                type: str
                description: Deprecated, please rename it to cos_marking_method. Select VLAN CoS marking method.
                choices:
                    - 'multi-stage'
                    - 'static'
            exceed-cos:
                type: str
                description: Deprecated, please rename it to exceed_cos. VLAN CoS mark for traffic in [guaranteed-bandwidth, exceed-bandwidth].
            maximum-cos:
                type: str
                description: Deprecated, please rename it to maximum_cos. VLAN CoS mark for traffic in [exceed-bandwidth, maximum-bandwidth].
'''
