...
DOCUMENTATION = '''
---
module: fmgr_fmupdate_fdssetting_pushoverride
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/fmupdate/fds-setting/push-override/{push-override}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'fmupdate_fdssetting_pushoverride'),
