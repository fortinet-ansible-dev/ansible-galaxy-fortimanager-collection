...
DOCUMENTATION = '''
---
module: fmgr_system_logfetch_clientprofile_devicefilter
short_description: List of device filter.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_logfetch_clientprofile_devicefilter'),
