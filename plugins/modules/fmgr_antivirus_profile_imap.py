...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_imap
short_description: Configure IMAP AntiVirus options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/imap/{imap}',
        '/pm/config/global/obj/antivirus/profile/{profile}/imap/{imap}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_imap'),
