...
DOCUMENTATION = '''
---
module: fmgr_router_communitylist_rule
short_description: Community list rule.
description:
...
options:
    ...
    adom:
        ...
        required: true
    community-list:
        description: Deprecated, please use "community_list"
        type: str
    community_list:
        description: The parameter (community-list) in requested url.
        type: str
    router_communitylist_rule:
        ...
        suboptions:
            action:
                type: str
                description: Permit or deny route-based operations, based on the routes COMMUNITY attribute.
                choices:
                    - 'deny'
                    - 'permit'
            id:
...
def main():
    ...
    url_params = ['adom', 'community-list']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'community-list': {'type': 'str', 'api_name': 'community_list'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_communitylist_rule'),
