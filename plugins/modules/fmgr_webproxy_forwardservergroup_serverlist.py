...
DOCUMENTATION = '''
---
module: fmgr_webproxy_forwardservergroup_serverlist
short_description: Add web forward servers to a list to form a server group.
description:
...
options:
    ...
    forward-server-group:
        description: Deprecated, please use "forward_server_group"
        type: str
    forward_server_group:
        description: The parameter (forward-server-group) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'forward-server-group']
    module_primary_key = 'name'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'forward-server-group': {'type': 'str', 'api_name': 'forward_server_group'},
        'forward_server_group': {'type': 'str'},
        'webproxy_forwardservergroup_serverlist': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'name': {'required': True, 'type': 'str'}, 'weight': {'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webproxy_forwardservergroup_serverlist'),
