...
DOCUMENTATION = '''
---
module: fmgr_isolator_profile_entries
short_description: Isolator profile entries
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Isolator profile entries
      fortinet.fortimanager.fmgr_isolator_profile_entries:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'isolator_profile_entries'),
