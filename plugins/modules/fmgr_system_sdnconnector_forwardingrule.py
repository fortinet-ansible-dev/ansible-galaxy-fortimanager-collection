...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_forwardingrule
short_description: Configure GCP forwarding rule.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configure GCP forwarding rule.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_forwardingrule'),
