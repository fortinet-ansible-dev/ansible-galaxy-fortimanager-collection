...
def main():
    ...
    perobject_jrpc_urls = [
        '/dvmdb/adom/{adom}/workflow/start/{session_id}/{{session_id}}',
        '/dvmdb/global/workflow/start/{session_id}/{{session_id}}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dvmdb_workflow_start'),
