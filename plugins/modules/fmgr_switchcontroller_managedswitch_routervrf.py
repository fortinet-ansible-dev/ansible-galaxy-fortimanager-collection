...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_managedswitch_routervrf
short_description: Configure VRF.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure VRF.
      fortinet.fortimanager.fmgr_switchcontroller_managedswitch_routervrf:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_routervrf'),
