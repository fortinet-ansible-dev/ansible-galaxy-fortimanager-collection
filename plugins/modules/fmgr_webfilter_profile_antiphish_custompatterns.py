...
DOCUMENTATION = '''
---
module: fmgr_webfilter_profile_antiphish_custompatterns
short_description: Custom username and password regex patterns.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Custom username and password regex patterns.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_profile_antiphish_custompatterns'),
