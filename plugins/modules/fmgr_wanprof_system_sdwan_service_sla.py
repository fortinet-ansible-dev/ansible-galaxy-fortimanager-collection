...
DOCUMENTATION = '''
---
module: fmgr_wanprof_system_sdwan_service_sla
...
def main():
    ...
    url_params = ['adom', 'wanprof', 'service']
    ...
    module_arg_spec = {
        ...
        'wanprof_system_sdwan_service_sla': {
            'type': 'dict',
            'v_range': [['6.4.1', '']],
            'options': {'health-check': {'v_range': [['6.4.1', '']], 'type': 'str'}, 'id': {'v_range': [['6.4.1', '']], 'required': True, 'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanprof_system_sdwan_service_sla'),
