...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_proxyredirect
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Firewall profile protocol options proxy redirect
      fortinet.fortimanager.fmgr_firewall_profileprotocoloptions_proxyredirect:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_proxyredirect'),
