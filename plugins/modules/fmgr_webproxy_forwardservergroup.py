...
options:
    ...
    webproxy_forwardservergroup:
        ...
        suboptions:
            affinity:
                type: str
                description: 'Enable/disable affinity, attaching a source-ips traffic to the assigned forwarding server until the forward-server-affinity-ti...'
                choices:
                    - 'disable'
                    - 'enable'
            group-down-option:
                type: str
                description: 'Action to take when all of the servers in the forward server group are down: block sessions until at least one server is back ...'
                choices:
                    - 'block'
                    - 'pass'
            ldb-method:
