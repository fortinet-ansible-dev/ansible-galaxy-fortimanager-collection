...
options:
    ...
    webproxy_forwardservergroup:
        ...
        suboptions:
            ...
            group-down-option:
                type: str
                description: Deprecated, please rename it to group_down_option. Action to take when all of the servers in the forward server group are down
                choices:
                    - 'block'
                    - 'pass'
            ldb-method:
...
def main():
    ...
    module_arg_spec = {
        ...
        'webproxy_forwardservergroup': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'affinity': {'choices': ['disable', 'enable'], 'type': 'str'},
                'group-down-option': {'choices': ['block', 'pass'], 'type': 'str'},
                'ldb-method': {'choices': ['weighted', 'least-session', 'active-passive'], 'type': 'str'},
                'name': {'required': True, 'type': 'str'},
                'server-list': {'type': 'list', 'options': {'name': {'type': 'str'}, 'weight': {'type': 'int'}}, 'elements': 'dict'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webproxy_forwardservergroup'),
