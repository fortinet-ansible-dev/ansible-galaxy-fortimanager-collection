...
DOCUMENTATION = '''
---
module: fmgr_webfilter_content_entries
...
options:
    ...
    webfilter_content_entries:
        ...
        suboptions:
            ...
            pattern-type:
                type: str
                description: Deprecated, please rename it to pattern_type. Banned word pattern type
                choices:
                    - 'wildcard'
                    - 'regexp'
            score:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_content_entries'),
