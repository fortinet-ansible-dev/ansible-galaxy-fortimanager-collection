...
options:
    ...
    ips_custom:
        ...
        suboptions:
            ...
            sig-name:
                type: str
                description: Deprecated, please rename it to sig_name. Sig name.
            signature:
                type: str
...
def main():
    ...
    module_arg_spec = {
        ...
        'ips_custom': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'action': {'choices': ['block', 'pass'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ips_custom'),
