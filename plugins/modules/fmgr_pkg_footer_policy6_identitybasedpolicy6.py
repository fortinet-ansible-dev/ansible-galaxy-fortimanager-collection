...
DOCUMENTATION = '''
---
module: fmgr_pkg_footer_policy6_identitybasedpolicy6
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_footer_policy6_identitybasedpolicy6'),
