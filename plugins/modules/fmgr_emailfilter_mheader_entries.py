...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_mheader_entries
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_mheader_entries'),
