...
options:
    ...
    pkg_authentication_rule:
        ...
        suboptions:
            ...
            ip-based:
                type: str
                description: 'Enable/disable IP-based authentication. Once a user authenticates all traffic from the IP address the user authenticated from ...'
                choices:
                    - 'disable'
                    - 'enable'
            name:
            ...
            protocol:
                type: str
                description: 'Select the protocol to use for authentication (default = http). Users connect to the FortiGate using this protocol and are ask...'
                choices:
                    - 'http'
                    - 'ftp'
                    - 'socks'
