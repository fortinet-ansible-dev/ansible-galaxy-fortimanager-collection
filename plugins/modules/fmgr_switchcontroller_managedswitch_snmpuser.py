...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_managedswitch_snmpuser
short_description: Configuration method to edit Simple Network Management Protocol (SNMP) users.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configuration method to edit Simple Network Management Protocol (SNMP) users.
