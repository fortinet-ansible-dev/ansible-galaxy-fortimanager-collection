...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_alertmail
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_alertmail'),
