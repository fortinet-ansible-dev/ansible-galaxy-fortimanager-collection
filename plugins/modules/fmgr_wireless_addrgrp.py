...
DOCUMENTATION = '''
---
module: fmgr_wireless_addrgrp
short_description: Configure the MAC address group.
description:
   ...
   tasks:
    - name: Configure the MAC address group.
      fmgr_wireless_addrgrp:
         ...
         wireless_addrgrp:
            addresses: <value of string>
            default-policy: <value in [deny, allow]>
            id: <value of string>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_addrgrp'),
