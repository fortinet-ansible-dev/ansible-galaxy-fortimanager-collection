...
DOCUMENTATION = '''
---
module: fmgr_dlp_dictionary_entries
    ...
    - name: DLP dictionary entries.
      fmgr_dlp_dictionary_entries:
        ...
        dlp_dictionary_entries:
          comment: <string>
          id: <integer>
          ignore-case: <value in [disable, enable]>
          pattern: <string>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dlp_dictionary_entries'),
