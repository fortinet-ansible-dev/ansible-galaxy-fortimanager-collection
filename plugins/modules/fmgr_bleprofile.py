    ...
    - name: Configure Bluetooth Low Energy profile.
      fmgr_bleprofile:
        ...
        bleprofile:
          ...
          comment: <string>
          eddystone-instance: <string>
          eddystone-namespace: <string>
          eddystone-url: <string>
          eddystone-url-encode-hex: <string>
          ibeacon-uuid: <string>
          major-id: <integer>
          minor-id: <integer>
          name: <string>
          ...
          scan-period: <integer>
          scan-threshold: <string>
          scan-time: <integer>
          scan-type: <value in [active, passive]>
          scan-window: <integer>
