...
options:
    ...
    adom:
        ...
        required: true
    vpntunnel:
        description: The parameter (vpntunnel) in requested url.
        type: str
        required: true
    dynamic_vpntunnel_dynamicmapping:
        ...
        suboptions:
            ...
            local-ipsec:
                type: str
                description: Deprecated, please rename it to local_ipsec. Local ipsec.
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_vpntunnel_dynamicmapping'),
