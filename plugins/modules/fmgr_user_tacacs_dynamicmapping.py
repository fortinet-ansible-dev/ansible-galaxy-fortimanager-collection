...
DOCUMENTATION = '''
---
module: fmgr_user_tacacs_dynamicmapping
...
def main():
    ...
    module_arg_spec = {
        ...
        'tacacs+': {'type': 'str', 'api_name': 'tacacs_'},
        'tacacs_': {'type': 'str'},
        'user_tacacs_dynamicmapping': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_tacacs_dynamicmapping'),
