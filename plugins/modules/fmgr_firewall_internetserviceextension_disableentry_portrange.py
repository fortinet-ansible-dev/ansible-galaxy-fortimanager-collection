...
DOCUMENTATION = '''
---
module: fmgr_firewall_internetserviceextension_disableentry_portrange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Port ranges in the disable entry.
      fortinet.fortimanager.fmgr_firewall_internetserviceextension_disableentry_portrange:
...
def main():
    ...
    url_params = ['adom', 'internet-service-extension', 'disable-entry']
