...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_fortianalyzer3_filter
short_description: Filter for FortiAnalyzer3 logging.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/fortianalyzer3/filter/{filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_fortianalyzer3_filter'),
