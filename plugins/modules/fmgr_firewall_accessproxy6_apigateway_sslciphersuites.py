...
DOCUMENTATION = '''
---
module: fmgr_firewall_accessproxy6_apigateway_sslciphersuites
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_accessproxy6_apigateway_sslciphersuites'),
