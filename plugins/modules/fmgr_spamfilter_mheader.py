...
DOCUMENTATION = '''
---
module: fmgr_spamfilter_mheader
...
def main():
            ...
            'options': {
                ...
                'entries': {
                    ...
                    'options': {
                        ...
                        'fieldbody': {'v_range': [['6.0.0', '7.2.1']], 'type': 'str'},
                        'fieldname': {'v_range': [['6.0.0', '7.2.1']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'spamfilter_mheader'),
