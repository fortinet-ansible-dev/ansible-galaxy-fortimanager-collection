...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_webfilter
short_description: Web filter.
description:
...
def main():
    ...
    url_params = ['user']
    module_primary_key = 'web-filter-name'
    module_arg_spec = {
        'user': {'required': True, 'type': 'str'},
        'system_admin_user_webfilter': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'web-filter-name': {'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_webfilter'),
