...
DOCUMENTATION = '''
---
module: fmgr_firewall_multicastaddress6_tagging
...
options:
    ...
    adom:
        ...
        required: true
    multicast-address6:
        description: Deprecated, please use "multicast_address6"
        type: str
    multicast_address6:
        description: The parameter (multicast-address6) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'multicast-address6']
    module_primary_key = 'name'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'multicast-address6': {'type': 'str', 'api_name': 'multicast_address6'},
        'multicast_address6': {'type': 'str'},
        'firewall_multicastaddress6_tagging': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_multicastaddress6_tagging'),
