...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_smtp
short_description: Configure SMTP AntiVirus options.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configure SMTP AntiVirus options.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/smtp/{smtp}',
        '/pm/config/global/obj/antivirus/profile/{profile}/smtp/{smtp}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_smtp'),
