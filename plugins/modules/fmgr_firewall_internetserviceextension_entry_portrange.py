...
DOCUMENTATION = '''
---
module: fmgr_firewall_internetserviceextension_entry_portrange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Port ranges in the custom entry.
      fortinet.fortimanager.fmgr_firewall_internetserviceextension_entry_portrange:
...
def main():
    ...
    url_params = ['adom', 'internet-service-extension', 'entry']
