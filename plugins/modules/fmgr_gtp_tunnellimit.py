...
DOCUMENTATION = '''
---
module: fmgr_gtp_tunnellimit
short_description: GTP tunnel limiter.
description:
...
options:
    ...
    gtp_tunnellimit:
        ...
        suboptions:
            ...
            tunnel-limit:
                type: int
                description: Deprecated, please rename it to tunnel_limit. Tunnel limit [1, 16000000].
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'gtp_tunnellimit': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'name': {'required': True, 'type': 'str'}, 'tunnel-limit': {'type': 'int'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'gtp_tunnellimit'),
