    ...
    videofilter_profile:
        ...
        suboptions:
                ...
                suboptions:
                    filters:
                        ...
                        suboptions:
                            ...
                            category-id:
                                type: int
                                description: Deprecated, please rename it to category_id. Category ID.
                            id:
                                type: int
                                description: ID.
                            log:
            ...
            youtube-channel-filter:
                type: str
                description: Deprecated, please rename it to youtube_channel_filter. Set YouTube channel filter.
            youtube-restrict:
                type: str
                description: Deprecated, please rename it to youtube_restrict. Set YouTube-restrict mode.
                choices:
                    - 'strict'
                    - 'none'
                    - 'moderate'
            ...
            default-action:
                type: str
                description: Deprecated, please rename it to default_action. Video filter default action.
                choices:
                    - 'block'
                    - 'monitor'
                    - 'allow'
