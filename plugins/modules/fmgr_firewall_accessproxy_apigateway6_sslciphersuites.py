...
DOCUMENTATION = '''
---
module: fmgr_firewall_accessproxy_apigateway6_sslciphersuites
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_accessproxy_apigateway6_sslciphersuites'),
