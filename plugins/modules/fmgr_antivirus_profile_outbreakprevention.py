...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_outbreakprevention
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/antivirus/profile/{profile}/outbreak-prevention/{outbreak-prevention}',
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/outbreak-prevention/{outbreak-prevention}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_outbreakprevention'),
