...
options:
    ...
    dynamic_address:
        ...
        suboptions:
            default:
                type: raw
                description: (list or str) Default.
            description:
                type: str
            ...
            dynamic_addr_mapping:
                type: list
                elements: dict
                description: Dynamic addr mapping.
                suboptions:
                    addr:
                        type: str
                        description: Addr.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_address'),
