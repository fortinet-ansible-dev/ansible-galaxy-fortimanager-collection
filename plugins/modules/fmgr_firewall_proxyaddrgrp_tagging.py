...
DOCUMENTATION = '''
---
module: fmgr_firewall_proxyaddrgrp_tagging
...
options:
    ...
    adom:
        ...
        required: true
    proxy-addrgrp:
        description: Deprecated, please use "proxy_addrgrp"
        type: str
    proxy_addrgrp:
        description: The parameter (proxy-addrgrp) in requested url.
        type: str
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_proxyaddrgrp_tagging'),
