...
DOCUMENTATION = '''
---
module: fmgr_system_npu_isfnpqueues
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure queues of switch port connected to NP6 XAUI on ingress path.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/system/npu/isf-np-queues/{isf-np-queues}',
        '/pm/config/global/obj/system/npu/isf-np-queues/{isf-np-queues}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_isfnpqueues'),
