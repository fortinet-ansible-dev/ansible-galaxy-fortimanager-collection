...
DOCUMENTATION = '''
---
module: fmgr_system_admin_group
short_description: User group.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_group'),
