...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_policyblock
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Policy block write access.
      fortinet.fortimanager.fmgr_system_admin_user_policyblock:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_policyblock'),
