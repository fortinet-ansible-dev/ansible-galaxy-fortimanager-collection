...
options:
    ...
    pkg_firewall_dospolicy6_anomaly:
        ...
        suboptions:
            ...
            quarantine-expiry:
                type: str
                description: Deprecated, please rename it to quarantine_expiry. Duration of quarantine, from 1 minute to 364 days, 23 hours, and 59 min...
            quarantine-log:
                type: str
...
def main():
    ...
    url_params = ['adom', 'pkg', 'DoS-policy6']
