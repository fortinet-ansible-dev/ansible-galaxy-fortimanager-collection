...
options:
    ...
    firewall_decryptedtrafficmirror:
        ...
        suboptions:
            ...
            traffic-source:
                type: str
                description: Deprecated, please rename it to traffic_source. Source of decrypted traffic to be mirrored.
                choices:
                    - 'client'
                    - 'server'
                    - 'both'
            traffic-type:
                type: list
                elements: str
                description: Deprecated, please rename it to traffic_type. Types of decrypted traffic to be mirrored.
                choices:
                    - 'ssl'
                    - 'ssh'
'''
