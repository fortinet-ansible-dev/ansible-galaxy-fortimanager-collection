...
options:
    ...
    firewall_vendormac:
        ...
        suboptions:
            ...
            mac-number:
                type: int
                description: Deprecated, please rename it to mac_number. Mac number.
            name:
                type: str
                description: Name.
            obsolete:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/vendor-mac/{vendor-mac}',
        '/pm/config/global/obj/firewall/vendor-mac/{vendor-mac}'
    ]
