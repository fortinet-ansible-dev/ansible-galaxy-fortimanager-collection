...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_securitypolicy_sectionvalue
...
def main():
    jrpc_urls = [
        '/pm/config/adom/{adom}/pkg/{pkg}/firewall/security-policy/{security-policy}/section value'
    ]
    ...
    url_params = ['adom', 'pkg', 'security-policy']
    ...
    module_arg_spec = {
        ...
        'pkg_firewall_securitypolicy_sectionvalue': {
            'type': 'dict',
            'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']],
            'options': {
                'attr': {'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']], 'choices': ['label', 'global-label'], 'type': 'str'},
                'name': {'v_range': [['6.4.0', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']], 'type': 'str'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_securitypolicy_sectionvalue'),
