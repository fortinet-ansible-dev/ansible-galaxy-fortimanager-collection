...
DOCUMENTATION = '''
---
module: fmgr_system_npu_nputcam_miract
short_description: Mirror action of TCAM.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/system/npu/npu-tcam/{npu-tcam}/mir-act/{mir-act}',
        '/pm/config/global/obj/system/npu/npu-tcam/{npu-tcam}/mir-act/{mir-act}'
    ]
    ...
    module_arg_spec = {
        ...
        'system_npu_nputcam_miract': {
            'type': 'dict',
            'v_range': [['7.4.2', '']],
            'options': {'vlif': {'v_range': [['7.4.2', '']], 'type': 'int'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_nputcam_miract'),
