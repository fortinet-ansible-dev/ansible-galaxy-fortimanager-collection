...
DOCUMENTATION = '''
---
module: fmgr_webfilter_ftgdlocalcat
...
def main():
    ...
    module_arg_spec = {
        ...
        'webfilter_ftgdlocalcat': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'desc': {'type': 'str'}, 'id': {'required': True, 'type': 'int'}, 'status': {'choices': ['disable', 'enable'], 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_ftgdlocalcat'),
