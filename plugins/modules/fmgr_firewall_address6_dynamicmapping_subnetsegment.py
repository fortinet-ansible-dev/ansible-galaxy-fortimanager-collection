...
def main():
    ...
    url_params = ['adom', 'address6', 'dynamic_mapping']
    ...
    module_arg_spec = {
        ...
        'firewall_address6_dynamicmapping_subnetsegment': {
            ...
            'v_range': [['6.2.1', '7.4.0']],
            'options': {
                'name': {'v_range': [['6.2.1', '7.4.0']], 'required': True, 'type': 'str'},
                'type': {'v_range': [['6.2.1', '7.4.0']], 'choices': ['any', 'specific'], 'type': 'str'},
                'value': {'v_range': [['6.2.1', '7.4.0']], 'type': 'str'}
            }
