...
options:
    ...
    switchcontroller_lldpprofile_mednetworkpolicy:
        ...
        suboptions:
            dscp:
                type: int
                description: 'Advertised Differentiated Services Code Point (DSCP) value, a packet header value indicating the level of service requested fo...'
            name:
                type: str
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configuration method to edit Media Endpoint Discovery (MED) network policy type-length-value (TLV) categories.
