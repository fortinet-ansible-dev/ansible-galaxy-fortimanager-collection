...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_cifs_serverkeytab
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_cifs_serverkeytab'),
