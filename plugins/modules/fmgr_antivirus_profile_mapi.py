...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_mapi
short_description: Configure MAPI AntiVirus options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/mapi/{mapi}',
        '/pm/config/global/obj/antivirus/profile/{profile}/mapi/{mapi}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_mapi'),
