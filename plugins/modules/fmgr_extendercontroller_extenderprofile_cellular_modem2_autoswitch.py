...
DOCUMENTATION = '''
---
module: fmgr_extendercontroller_extenderprofile_cellular_modem2_autoswitch
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/extender-controller/extender-profile/{extender-profile}/cellular/modem2/auto-switch/{auto-switch}',
        '/pm/config/adom/{adom}/obj/extender-controller/extender-profile/{extender-profile}/cellular/modem2/auto-switch/{auto-switch}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extenderprofile_cellular_modem2_autoswitch'),
