...
options:
    ...
    adom:
        ...
        required: true
    nsx:
        description: The parameter (nsx) in requested url.
        type: str
        required: true
    user_nsx_service:
        ...
        suboptions:
            ...
            ref-id:
                type: str
                description: Deprecated, please rename it to ref_id.
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'nsx': {'required': True, 'type': 'str'},
        'user_nsx_service': {
            'type': 'dict',
            'v_range': [['7.0.4', '']],
            'options': {
                'id': {'v_range': [['7.0.4', '']], 'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_nsx_service'),
