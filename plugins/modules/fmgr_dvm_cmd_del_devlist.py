...
DOCUMENTATION = '''
---
module: fmgr_dvm_cmd_del_devlist
short_description: Delete a list of devices.
description:
    ...
    dvm_cmd_del_devlist:
        ...
        suboptions:
            ...
            del-dev-member-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to del_dev_member_list. Del dev member list.
                suboptions:
                    name:
                        type: str
                        description: Name.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dvm_cmd_del_devlist'),
