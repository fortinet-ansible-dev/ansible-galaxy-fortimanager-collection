...
DOCUMENTATION = '''
---
module: fmgr_system_logfetch_serversettings
short_description: Log-fetch server settings.
description:
...
def main():
    ...
    module_arg_spec = {
        'system_logfetch_serversettings': {
            ...
            'v_range': [['6.0.0', '7.2.1']],
            'options': {
                'max-conn-per-session': {'v_range': [['6.0.0', '7.2.1']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_logfetch_serversettings'),
