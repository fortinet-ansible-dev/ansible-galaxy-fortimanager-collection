...
DOCUMENTATION = '''
---
module: fmgr_firewall_mmsprofile_notifmsisdn
short_description: Notification for MSISDNs.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_mmsprofile_notifmsisdn'),
