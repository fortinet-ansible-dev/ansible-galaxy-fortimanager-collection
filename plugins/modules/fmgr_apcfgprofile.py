...
options:
    ...
    apcfgprofile:
        ...
        suboptions:
            ac-ip:
                type: str
                description: Deprecated, please rename it to ac_ip. IP address of the validation controller that AP must be able to join after applying...
            ac-port:
                type: int
                description: Deprecated, please rename it to ac_port. Port of the validation controller that AP must be able to join after applying AP ...
            ac-timer:
                type: int
                description: Deprecated, please rename it to ac_timer. Maximum waiting time for the AP to join the validation controller after applying...
            ac-type:
                type: str
                description: Deprecated, please rename it to ac_type. Validation controller type
                choices:
                    - 'default'
                    - 'specify'
                    - 'apcfg'
            command-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to command_list. Command list.
                suboptions:
                    id:
                        type: int
                    ...
                    passwd-value:
                        type: raw
                        description: (list) Deprecated, please rename it to passwd_value. AP local configuration command password value.
                    type:
                        type: str
            ...
            ap-family:
                type: str
                description: Deprecated, please rename it to ap_family. FortiAP family type
                choices:
                    - 'fap'
                    - 'fap-u'
                    - 'fap-c'
