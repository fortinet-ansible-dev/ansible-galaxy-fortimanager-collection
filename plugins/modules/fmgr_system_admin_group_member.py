...
DOCUMENTATION = '''
---
module: fmgr_system_admin_group_member
short_description: Group members.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_group_member'),
