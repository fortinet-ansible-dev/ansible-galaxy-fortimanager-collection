...
def main():
    ...
    url_params = ['adom', 'devprof', 'exclude-list']
    module_primary_key = None
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'devprof': {'required': True, 'type': 'str'},
        'exclude-list': {'type': 'str', 'api_name': 'exclude_list'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'devprof_log_syslogd_filter_excludelist_fields'),
