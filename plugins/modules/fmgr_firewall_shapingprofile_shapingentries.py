...
options:
    ...
    firewall_shapingprofile_shapingentries:
        ...
        suboptions:
            ...
            cburst-in-msec:
                type: int
                description: Deprecated, please rename it to cburst_in_msec. Number of bytes that can be burst as fast as the interface can transmit.
            limit:
                type: int
...
def main():
    ...
    url_params = ['adom', 'shaping-profile']
