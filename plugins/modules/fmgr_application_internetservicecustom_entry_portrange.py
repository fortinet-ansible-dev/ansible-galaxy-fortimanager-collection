...
DOCUMENTATION = '''
---
module: fmgr_application_internetservicecustom_entry_portrange
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'application_internetservicecustom_entry_portrange'),
