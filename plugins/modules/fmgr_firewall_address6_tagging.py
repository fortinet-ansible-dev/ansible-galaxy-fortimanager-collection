...
DOCUMENTATION = '''
---
module: fmgr_firewall_address6_tagging
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the taggings in the IPv6 address
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "firewall_address6_tagging"
          params:
            adom: "ansible"
            address6: "ansible-test" # name
            tagging: "your_value"
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_address6_tagging'),
