...
def main():
    urls_list = [
        '/pm/wanprof/adom/{adom}/{pkg_path}/scope member'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_wanprof_scopemember'),
