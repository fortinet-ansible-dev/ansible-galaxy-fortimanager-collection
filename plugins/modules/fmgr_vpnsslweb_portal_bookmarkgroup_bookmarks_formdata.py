...
DOCUMENTATION = '''
---
module: fmgr_vpnsslweb_portal_bookmarkgroup_bookmarks_formdata
...
def main():
    ...
    url_params = ['adom', 'portal', 'bookmark-group', 'bookmarks']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnsslweb_portal_bookmarkgroup_bookmarks_formdata'),
