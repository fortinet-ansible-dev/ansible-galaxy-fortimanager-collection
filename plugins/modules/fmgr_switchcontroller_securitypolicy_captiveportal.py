...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_securitypolicy_captiveportal
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_securitypolicy_captiveportal': {
            ...
            'v_range': [['6.0.0', '6.2.1']],
            'options': {
                'name': {'v_range': [['6.0.0', '6.2.1']], 'required': True, 'type': 'str'},
                'policy-type': {'v_range': [['6.0.0', '6.2.1']], 'choices': ['captive-portal'], 'type': 'str'},
                'vlan': {'v_range': [['6.0.0', '6.2.1']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_securitypolicy_captiveportal'),
