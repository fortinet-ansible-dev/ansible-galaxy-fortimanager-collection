...
DOCUMENTATION = '''
---
module: fmgr_webfilter_profile_urlextraction
short_description: Configure URL Extraction
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/webfilter/profile/{profile}/url-extraction/{url-extraction}',
        '/pm/config/global/obj/webfilter/profile/{profile}/url-extraction/{url-extraction}'
    ]
    ...
    module_arg_spec = {
        ...
        'webfilter_profile_urlextraction': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'redirect-header': {'type': 'str'},
                'redirect-no-content': {'choices': ['disable', 'enable'], 'type': 'str'},
                'redirect-url': {'type': 'str'},
                'server-fqdn': {'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_profile_urlextraction'),
