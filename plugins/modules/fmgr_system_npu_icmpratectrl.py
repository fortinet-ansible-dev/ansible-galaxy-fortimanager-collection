...
DOCUMENTATION = '''
---
module: fmgr_system_npu_icmpratectrl
short_description: Configure the rate of ICMP messages generated by this FortiGate.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure the rate of ICMP messages generated by this FortiGate.
      fortinet.fortimanager.fmgr_system_npu_icmpratectrl:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_icmpratectrl'),
