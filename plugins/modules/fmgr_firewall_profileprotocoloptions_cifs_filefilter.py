...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_cifs_filefilter
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/firewall/profile-protocol-options/{profile-protocol-options}/cifs/file-filter/{file-filter}',
        '/pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}/cifs/file-filter/{file-filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_cifs_filefilter'),
