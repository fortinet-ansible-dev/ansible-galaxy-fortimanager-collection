...
DOCUMENTATION = '''
---
module: fmgr_router_prefixlist_rule
short_description: IPv4 prefix list rule.
description:
...
options:
    ...
    adom:
        ...
        required: true
    prefix-list:
        description: Deprecated, please use "prefix_list"
        type: str
    prefix_list:
        description: The parameter (prefix-list) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'prefix-list']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'prefix-list': {'type': 'str', 'api_name': 'prefix_list'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_prefixlist_rule'),
