...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_profile_smtp
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/emailfilter/profile/{profile}/smtp/{smtp}',
        '/pm/config/adom/{adom}/obj/emailfilter/profile/{profile}/smtp/{smtp}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_profile_smtp'),
