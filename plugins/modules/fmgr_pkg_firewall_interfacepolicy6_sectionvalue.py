...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_interfacepolicy6_sectionvalue
...
options:
    ...
    pkg:
        ...
        required: true
    interface-policy6:
        description: Deprecated, please use "interface_policy6"
        type: str
    interface_policy6:
...
def main():
    ...
    module_arg_spec = {
        ...
        'interface-policy6': {'type': 'str', 'api_name': 'interface_policy6'},
        ...
        'pkg_firewall_interfacepolicy6_sectionvalue': {
            ...
            'options': {
                'attr': {'v_range': [['6.0.0', '7.2.2'], ['7.2.6', '7.2.11'], ['7.4.3', '']], 'choices': ['label', 'global-label'], 'type': 'str'},
                'name': {'v_range': [['6.0.0', '7.2.2'], ['7.2.6', '7.2.11'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_interfacepolicy6_sectionvalue'),
