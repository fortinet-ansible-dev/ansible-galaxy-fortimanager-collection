...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_ociregionlist
short_description: Configure OCI region list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure OCI region list.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_ociregionlist'),
