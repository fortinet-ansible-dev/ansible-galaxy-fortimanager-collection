...
DOCUMENTATION = '''
---
module: fmgr_firewall_addrgrp6_tagging
...
EXAMPLES = '''
 ...
 - name: gathering fortimanager facts
   ...
   vars:
     ...
     ansible_httpapi_port: 443
   tasks:
    - name: retrieve all the taggings in the IPv6 address group
      fmgr_fact:
        facts:
            selector: 'firewall_addrgrp6_tagging'
            params:
                adom: 'ansible'
                addrgrp6: 'ansible-addrgrp6' # name
                tagging: 'your_value'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_addrgrp6_tagging'),
