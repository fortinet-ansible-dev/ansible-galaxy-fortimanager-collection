...
options:
    ...
    emailfilter_fortishield:
        ...
        suboptions:
            spam-submit-force:
                type: str
                description: Deprecated, please rename it to spam_submit_force. Enable/disable force insertion of a new mime entity for the submission ...
                choices:
                    - 'disable'
                    - 'enable'
            spam-submit-srv:
                type: str
                description: Deprecated, please rename it to spam_submit_srv. Hostname of the spam submission server.
            spam-submit-txt2htm:
                type: str
                description: Deprecated, please rename it to spam_submit_txt2htm. Enable/disable conversion of text email to HTML email.
                choices:
                    - 'disable'
                    - 'enable'
'''
