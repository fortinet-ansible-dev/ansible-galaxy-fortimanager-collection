...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_mapi
short_description: Configure MAPI protocol options.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configure MAPI protocol options.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}/mapi/{mapi}',
        '/pm/config/global/obj/firewall/profile-protocol-options/{profile-protocol-options}/mapi/{mapi}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_mapi'),
