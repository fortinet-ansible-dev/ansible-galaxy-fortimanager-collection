...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pblock_firewall_policy_sectionvalue
...
def main():
    urls_list = [
        '/pm/config/adom/{adom}/pblock/{pblock}/firewall/policy/{policy}/section value'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_pblock_firewall_policy_sectionvalue'),
