...
DOCUMENTATION = '''
---
module: fmgr_extendercontroller_extenderprofile_cellular_smsnotification_alert
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/extender-controller/extender-profile/{extender-profile}/cellular/sms-notification/alert/{alert}',
        '/pm/config/adom/{adom}/obj/extender-controller/extender-profile/{extender-profile}/cellular/sms-notification/alert/{alert}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extenderprofile_cellular_smsnotification_alert'),
