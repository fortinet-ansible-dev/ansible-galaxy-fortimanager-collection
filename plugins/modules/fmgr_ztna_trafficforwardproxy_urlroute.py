...
DOCUMENTATION = '''
---
module: fmgr_ztna_trafficforwardproxy_urlroute
short_description: Ztna traffic forward proxy url route
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_trafficforwardproxy_urlroute'),
