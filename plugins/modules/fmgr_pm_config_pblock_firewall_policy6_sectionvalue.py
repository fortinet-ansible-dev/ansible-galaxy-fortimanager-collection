...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pblock_firewall_policy6_sectionvalue
...
options:
    ...
    pblock:
        ...
        required: true
    policy6:
        description: The parameter (policy6) in requested url.
        type: str
        required: true
...
def main():
    urls_list = [
        '/pm/config/adom/{adom}/pblock/{pblock}/firewall/policy6/{policy6}/section value'
    ]
    url_params = ['adom', 'pblock', 'policy6']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_pblock_firewall_policy6_sectionvalue'),
