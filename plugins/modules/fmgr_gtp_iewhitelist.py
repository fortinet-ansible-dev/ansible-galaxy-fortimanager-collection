...
DOCUMENTATION = '''
---
module: fmgr_gtp_iewhitelist
short_description: IE white list.
description:
        ...
        suboptions:
            entries:
                ...
                suboptions:
                    ...
                    ie:
                        type: int
                        description: 'IE ID (1 - 255).'
                    message:
                        type: int
                        description: 'Message ID (1 - 255).'
            name:
                type: str
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'gtp_iewhitelist'),
