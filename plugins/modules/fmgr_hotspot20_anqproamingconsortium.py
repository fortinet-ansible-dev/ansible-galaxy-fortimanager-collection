...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_anqproamingconsortium
    ...
    hotspot20_anqproamingconsortium:
        ...
        suboptions:
            ...
            oi-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to oi_list. Oi list.
                suboptions:
                    comment:
                        type: str
                        description: Comment.
...
def main():
    ...
    module_arg_spec = {
        ...
        'hotspot20_anqproamingconsortium': {
            ...
            'options': {
                ...
                'oi-list': {'type': 'list', 'options': {'comment': {'type': 'str'}, 'index': {'type': 'int'}, 'oi': {'type': 'str'}}, 'elements': 'dict'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_anqproamingconsortium'),
