...
options:
    ...
    fmg_fabric_authorization_template:
        ...
        suboptions:
            ...
            extender-controller:
                type: str
                description: Deprecated, please rename it to extender_controller.
                choices:
                    - 'disable'
                    - 'enable'
            name:
            ...
            platforms:
                ...
                suboptions:
                    ...
                    extension-type:
                        type: str
                        description: Deprecated, please rename it to extension_type.
                        choices:
                            - 'wan-extension'
                            - 'lan-extension'
                    fortilink:
            ...
            switch-controller:
                type: str
                description: Deprecated, please rename it to switch_controller.
                choices:
                    - 'disable'
                    - 'enable'
            wireless-controller:
                type: str
                description: Deprecated, please rename it to wireless_controller.
                choices:
                    - 'disable'
                    - 'enable'
'''
