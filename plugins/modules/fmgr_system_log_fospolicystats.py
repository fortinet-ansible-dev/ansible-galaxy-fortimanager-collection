...
options:
    ...
    system_log_fospolicystats:
        ...
        suboptions:
            retention-days:
                type: int
                description: Deprecated, please rename it to retention_days. Number of days for FortiOS policy stats data storage.
            sampling-interval:
                type: int
                description: Deprecated, please rename it to sampling_interval. Interval to request policy stats data from FortiOS in minutes.
            status:
                type: str
                description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/log/fos-policy-stats/{fos-policy-stats}'
    ]
