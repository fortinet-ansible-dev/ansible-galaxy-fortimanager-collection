...
def main():
    ...
    perobject_jrpc_urls = [
        '/securityconsole/pblock/clone/{clone}'
    ]
    ...
    module_arg_spec = {
        'securityconsole_pblock_clone': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'adom': {'type': 'str'}, 'dst_name': {'type': 'str'}, 'pblock': {'type': 'str'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'securityconsole_pblock_clone'),
