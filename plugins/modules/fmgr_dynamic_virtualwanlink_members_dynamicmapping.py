...
options:
    ...
    dynamic_virtualwanlink_members_dynamicmapping:
        ...
        suboptions:
            ...
            detect-failtime:
                type: int
                description: Deprecated, please rename it to detect_failtime.
            detect-http-get:
                type: str
                description: Deprecated, please rename it to detect_http_get.
            detect-http-match:
                type: str
                description: Deprecated, please rename it to detect_http_match.
            detect-http-port:
                type: int
                description: Deprecated, please rename it to detect_http_port.
            detect-interval:
                type: int
                description: Deprecated, please rename it to detect_interval.
            detect-protocol:
                type: str
                description: Deprecated, please rename it to detect_protocol.
                choices:
                    - 'ping'
                    - 'tcp-echo'
                    - 'udp-echo'
            ...
            detect-recoverytime:
                type: int
                description: Deprecated, please rename it to detect_recoverytime.
            detect-server:
                type: str
                description: Deprecated, please rename it to detect_server.
            detect-timeout:
                type: int
                description: Deprecated, please rename it to detect_timeout.
            gateway:
                type: str
                description: No description.
            gateway6:
            ...
            volume-ratio:
                type: int
                description: Deprecated, please rename it to volume_ratio.
            weight:
                type: int
                description: No description.
'''
