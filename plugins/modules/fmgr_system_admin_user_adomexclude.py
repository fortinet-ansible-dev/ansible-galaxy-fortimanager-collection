...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_adomexclude
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_admin_user_adomexclude': {
            'type': 'dict',
            'v_range': [['6.0.0', '7.0.2']],
            'options': {'adom-name': {'v_range': [['6.0.0', '7.0.2']], 'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_adomexclude'),
