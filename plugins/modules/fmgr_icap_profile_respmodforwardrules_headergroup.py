...
DOCUMENTATION = '''
---
module: fmgr_icap_profile_respmodforwardrules_headergroup
...
options:
    ...
    respmod-forward-rules:
        description: Deprecated, please use "respmod_forward_rules"
        type: str
    respmod_forward_rules:
        description: The parameter (respmod-forward-rules) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'profile', 'respmod-forward-rules']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'profile': {'required': True, 'type': 'str'},
        'respmod-forward-rules': {'type': 'str', 'api_name': 'respmod_forward_rules'},
        'respmod_forward_rules': {'type': 'str'},
        'icap_profile_respmodforwardrules_headergroup': {
            'type': 'dict',
            'v_range': [['6.4.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'icap_profile_respmodforwardrules_headergroup'),
