...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the geoip-countries
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_geoipcountry': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'id': {'required': True, 'type': 'str'}, 'name': {'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_geoipcountry'),
