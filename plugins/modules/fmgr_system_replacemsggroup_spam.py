...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_spam
...
EXAMPLES = '''
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the spams of replacement message group
      fmgr_fact:
        facts:
            selector: 'system_replacemsggroup_spam'
            params:
                adom: 'ansible'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_spam'),
