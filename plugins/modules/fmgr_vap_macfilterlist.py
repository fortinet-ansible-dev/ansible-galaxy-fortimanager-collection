...
def main():
    ...
    module_arg_spec = {
        ...
        'vap_macfilterlist': {
            ...
            'options': {
                ...
                'mac': {'type': 'str'},
                'mac-filter-policy': {'choices': ['deny', 'allow'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vap_macfilterlist'),
