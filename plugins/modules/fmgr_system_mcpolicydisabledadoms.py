...
DOCUMENTATION = '''
---
module: fmgr_system_mcpolicydisabledadoms
short_description: Multicast policy disabled adoms.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_mcpolicydisabledadoms'),
