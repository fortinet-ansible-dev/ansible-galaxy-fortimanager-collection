...
DOCUMENTATION = '''
---
module: fmgr_system_log_maildomain
short_description: FortiMail domain setting.
description:
...
def main():
    ...
    module_arg_spec = {
        'system_log_maildomain': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'devices': {'type': 'str'}, 'domain': {'type': 'str'}, 'id': {'required': True, 'type': 'int'}, 'vdom': {'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_log_maildomain'),
