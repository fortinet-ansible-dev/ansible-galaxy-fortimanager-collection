...
DOCUMENTATION = '''
---
module: fmgr_system_certificate_ca
...
options:
    ...
    system_certificate_ca:
        ...
        suboptions:
            ca:
                type: raw
                description: (list) CA certificate.
            comment:
                type: str
...
def main():
    ...
    module_arg_spec = {
        'system_certificate_ca': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'ca': {'type': 'raw'}, 'comment': {'type': 'str'}, 'name': {'required': True, 'type': 'str'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_certificate_ca'),
