...
DOCUMENTATION = '''
---
module: fmgr_firewall_gtp_apn
short_description: APN.
description:
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the APNs
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "firewall_gtp_apn"
          params:
            adom: "FortiCarrier" # FortiCarrier only object, need a FortiCarrier adom
            gtp: "ansible-test" # name
            apn: "your_value"
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_gtp_apn'),
