...
DOCUMENTATION = '''
---
module: fmgr_wireless_accesscontrollist
    ...
    wireless_accesscontrollist:
        ...
        suboptions:
            ...
            layer3-ipv4-rules:
                type: list
                elements: dict
                description: Deprecated, please rename it to layer3_ipv4_rules. Layer3 ipv4 rules.
                suboptions:
                    action:
                        type: str
                    ...
                    rule-id:
                        type: int
                        description: Deprecated, please rename it to rule_id. Rule ID
                    srcaddr:
                        type: str
            ...
            layer3-ipv6-rules:
                type: list
                elements: dict
                description: Deprecated, please rename it to layer3_ipv6_rules. Layer3 ipv6 rules.
                suboptions:
                    action:
                        type: str
                        description: Policy action
        ...
        'wireless_accesscontrollist': {
            ...
            'options': {
                ...
                'layer3-ipv4-rules': {
                    ...
                    'type': 'list',
                    'options': {
                        'action': {'v_range': [['7.2.1', '']], 'choices': ['allow', 'deny'], 'type': 'str'},
                        'comment': {'v_range': [['7.2.1', '']], 'type': 'str'},
                        'dstaddr': {'v_range': [['7.2.1', '']], 'type': 'str'},
                        'dstport': {'v_range': [['7.2.1', '']], 'type': 'int'},
                        'protocol': {'v_range': [['7.2.1', '']], 'type': 'int'},
                        'rule-id': {'v_range': [['7.2.1', '']], 'type': 'int'},
                        'srcaddr': {'v_range': [['7.2.1', '']], 'type': 'str'},
                        'srcport': {'v_range': [['7.2.1', '']], 'type': 'int'}
                    },
                    'elements': 'dict'
                },
                'layer3-ipv6-rules': {
