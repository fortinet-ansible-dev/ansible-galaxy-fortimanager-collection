    ...
    waf_profile_method:
        ...
        suboptions:
            default-allowed-methods:
                type: list
                elements: str
                description: Deprecated, please rename it to default_allowed_methods.
                choices:
                    - 'delete'
                    - 'get'
                    - 'head'
            ...
            method-policy:
                type: list
                elements: dict
                description: Deprecated, please rename it to method_policy.
                suboptions:
                    address:
                        type: str
                    ...
                    allowed-methods:
                        type: list
                        elements: str
                        description: Deprecated, please rename it to allowed_methods.
                        choices:
                            - 'delete'
                            - 'get'
                            - 'head'
