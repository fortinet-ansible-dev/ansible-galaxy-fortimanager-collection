...
DOCUMENTATION = '''
---
module: fmgr_webfilter_profile_filefilter_entries
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_profile_filefilter_entries'),
