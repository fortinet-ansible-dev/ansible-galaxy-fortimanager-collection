...
DOCUMENTATION = '''
---
module: fmgr_firewall_address_tagging
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the taggings in the address
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "firewall_address_tagging"
          params:
            adom: "ansible"
            address: "ansible-test1" # name
            tagging: "your_value"
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_address_tagging'),
