...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_nntp
short_description: Configure NNTP protocol options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}/nntp/{nntp}',
        '/pm/config/global/obj/firewall/profile-protocol-options/{profile-protocol-options}/nntp/{nntp}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_nntp'),
