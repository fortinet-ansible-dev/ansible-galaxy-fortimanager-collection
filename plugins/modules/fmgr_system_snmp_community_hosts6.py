...
DOCUMENTATION = '''
---
module: fmgr_system_snmp_community_hosts6
short_description: Allow hosts configuration for IPv6.
description:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_snmp_community_hosts6': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'id': {'required': True, 'type': 'int'}, 'interface': {'type': 'str'}, 'ip': {'type': 'str'}}
