...
DOCUMENTATION = '''
---
module: fmgr_user_securityexemptlist_rule
...
def main():
    ...
    url_params = ['adom', 'security-exempt-list']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'security-exempt-list': {'type': 'str', 'api_name': 'security_exempt_list'},
        'security_exempt_list': {'type': 'str'},
        'user_securityexemptlist_rule': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_securityexemptlist_rule'),
