...
short_description: Install policies to device from preview cache. Only to be used when a preview cache is previously generated by install/package command.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Install policies to device from preview cache. Only to be used when a preview cache is previously generated by install/package command.
