...
options:
    ...
    devprof_device_profile_fortianalyzer:
        ...
        suboptions:
            managed-sn:
                type: str
                description: Deprecated, please rename it to managed_sn. Managed sn.
            target:
                type: str
                description: Target.
                choices:
            ...
            target-sn:
                type: raw
                description: (list) Deprecated, please rename it to target_sn. Target sn.
'''
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/devprof/{devprof}/device/profile/fortianalyzer/{fortianalyzer}'
    ]
