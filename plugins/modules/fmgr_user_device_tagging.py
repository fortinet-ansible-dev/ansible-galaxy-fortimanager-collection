...
DOCUMENTATION = '''
---
module: fmgr_user_device_tagging
...
def main():
    ...
    module_arg_spec = {
        ...
        'user_device_tagging': {
            ...
            'v_range': [['6.0.0', '7.4.2']],
            'options': {
                'category': {'v_range': [['6.0.0', '7.4.2']], 'type': 'str'},
                'name': {'v_range': [['6.0.0', '7.4.2']], 'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_device_tagging'),
