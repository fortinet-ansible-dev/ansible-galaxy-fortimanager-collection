...
DOCUMENTATION = '''
---
module: fmgr_devprof_log_syslogd_setting_customfieldname
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'devprof_log_syslogd_setting_customfieldname'),
