...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_trafficquota
...
EXAMPLES = '''
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the traffic quotas of replacement message group
      fmgr_fact:
        facts:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_trafficquota'),
