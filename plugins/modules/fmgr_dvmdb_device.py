...
options:
    ...
    dvmdb_device:
        ...
        suboptions:
            ...
            faz.full_act:
                type: int
                description: 'Faz.Full_Act.'
            faz.perm:
                type: int
                description: 'Faz.Perm.'
            faz.quota:
                type: int
                description: 'Faz.Quota.'
            faz.used:
                type: int
                description: 'Faz.Used.'
            fex_cnt:
                type: int
                description: 'Fex_Cnt.'
            flags:
            ...
            ha_group_id:
                type: int
                description: 'Ha_Group_Id.'
            ha_group_name:
                type: str
                description: 'Ha_Group_Name.'
            ha_mode:
                type: str
                default: 'standalone'
            ...
            hdisk_size:
                type: int
                description: 'Hdisk_Size.'
            hostname:
                type: str
                description: 'Hostname.'
            hw_rev_major:
                type: int
                description: 'Hw_Rev_Major.'
            hw_rev_minor:
                type: int
                description: 'Hw_Rev_Minor.'
            ip:
                type: str
                description: 'Ip.'
            ips_ext:
            ...
            last_resync:
                type: int
                description: 'Last_Resync.'
            latitude:
                type: str
                description: 'Latitude.'
            lic_flags:
                type: int
                description: 'Lic_Flags.'
            lic_region:
                type: str
                description: 'Lic_Region.'
            location_from:
                type: str
                description: 'Location_From.'
            logdisk_size:
                type: int
                description: 'Logdisk_Size.'
            longitude:
                type: str
            ...
            vm_cpu_limit:
                type: int
                description: 'Vm_Cpu_Limit.'
            vm_lic_expire:
                type: int
                description: 'Vm_Lic_Expire.'
            vm_mem:
                type: int
                description: 'Vm_Mem.'
            vm_mem_limit:
                type: int
                description: 'Vm_Mem_Limit.'
            vm_status:
                type: int
                description: 'Vm_Status.'
            module_sn:
                type: str
                description: 'Module_Sn.'
            prefer_img_ver:
                type: str
                description: 'Prefer_Img_Ver.'
            prio:
                type: int
                description: 'Prio.'
            role:
            ...
            nsxt_service_name:
                type: str
                description: 'Nsxt_Service_Name.'
            private_key:
                type: str
                description: 'Private_Key.'
            private_key_status:
                type: int
                description: 'Private_Key_Status.'
