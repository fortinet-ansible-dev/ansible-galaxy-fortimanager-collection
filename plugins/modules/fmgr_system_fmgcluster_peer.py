...
DOCUMENTATION = '''
---
module: fmgr_system_fmgcluster_peer
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Peer.
      fortinet.fortimanager.fmgr_system_fmgcluster_peer:
...
def main():
    ...
    module_arg_spec = {
        'system_fmgcluster_peer': {
            ...
            'options': {
                ...
                'name': {'v_range': [['7.6.0', '7.6.0']], 'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_fmgcluster_peer'),
