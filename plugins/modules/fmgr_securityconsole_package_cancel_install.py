...
short_description: Cancel policy install and clear preview cache. Only to be used when a preview cache is previously generated by install/package command.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Cancel policy install and clear preview cache. Only to be used when a preview cache is previously generated by install/package command.
