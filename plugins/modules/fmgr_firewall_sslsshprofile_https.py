...
DOCUMENTATION = '''
---
module: fmgr_firewall_sslsshprofile_https
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/https/{https}',
        '/pm/config/global/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/https/{https}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_sslsshprofile_https'),
