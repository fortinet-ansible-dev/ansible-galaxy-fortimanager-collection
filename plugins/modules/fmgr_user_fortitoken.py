...
options:
    ...
    user_fortitoken:
        ...
        suboptions:
            ...
            os-ver:
                type: str
                description: Deprecated, please rename it to os_ver. Device Mobile Version.
            reg-id:
                type: str
                description: Deprecated, please rename it to reg_id. Device Reg ID.
            serial-number:
                type: str
                description: Deprecated, please rename it to serial_number. Serial number.
                required: true
            status:
                type: str
                description: Status
