...
DOCUMENTATION = '''
---
module: fmgr_system_autodelete_logautodeletion
short_description: Automatic deletion policy for device logs.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/auto-delete/log-auto-deletion/{log-auto-deletion}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autodelete_logautodeletion'),
