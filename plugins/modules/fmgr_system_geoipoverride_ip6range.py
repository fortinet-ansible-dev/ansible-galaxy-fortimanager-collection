...
DOCUMENTATION = '''
---
module: fmgr_system_geoipoverride_ip6range
short_description: Table of IPv6 ranges assigned to country.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_geoipoverride_ip6range'),
