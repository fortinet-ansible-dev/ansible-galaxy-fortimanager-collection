...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_h2qpadviceofcharge
         ...
         hotspot20_h2qpadviceofcharge:
            aoc-list:
              -
                  ...
                  nai-realm-encoding: <value of string>
                  name: <value of string>
                  plan-info:
                    -
                        currency: <value of string>
                        info-file: <value of string>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_h2qpadviceofcharge'),
