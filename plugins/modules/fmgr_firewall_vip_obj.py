    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                http-cookie-share:
                    type: str
                    description: 'Control sharing of cookies across virtual servers. same-ip means a cookie from one virtual server can be used by another. ...'
                    choices:
                        - 'disable'
                        - 'same-ip'
                http-ip-header:
                ...
                http-ip-header-name:
                    type: str
                    description: 'For HTTP multiplexing, enter a custom HTTPS header name. The original client IP address is added to this header. If empty,...'
                http-multiplex:
                    type: str
                ...
                realservers:
                    -
                        ...
                        max-connections:
                            type: int
                            description: 'Max number of active connections that can be directed to the real server. When reached, sessions are sent to other...'
                        monitor:
                            type: str
                            description: 'Name of the health check monitor to use when polling to determine a virtual servers connectivity status.'
                        port:
                        ...
                        weight:
                            type: int
                            description: 'Weight of the real server. If weighted load balancing is enabled, the server with the highest weight gets more con...'
                server-type:
                    type: str
                ...
                ssl-mode:
                    type: str
                    description: 'Apply SSL offloading between the client and the FortiGate (half) or from the client to the FortiGate and from the FortiGat...'
                    choices:
                        - 'half'
                        - 'full'
                ssl-pfs:
                ...
                ssl-send-empty-frags:
                    type: str
                    description: 'Enable/disable sending empty fragments to avoid CBC IV attacks (SSL 3.0 & TLS 1.0 only). May need to be disabled for compa...'
                    choices:
                        - 'disable'
                        - 'enable'
                ssl-server-algorithm:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/vip/{vip}'
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            extip:
               type: str
               description: 'IP address or address range on the external interface that you want to map to an address or address range on the destination ne...'
            extport:
               type: str
               description: 'Incoming port number range that you want to map to a port number range on the destination network.'
            gratuitous-arp-interval:
            ...
            http-cookie-share:
               type: str
               description: 'Control sharing of cookies across virtual servers. same-ip means a cookie from one virtual server can be used by another. Disab...'
            http-ip-header:
               type: str
               description: 'For HTTP multiplexing, enable to add the original client IP address in the XForwarded-For HTTP header.'
            http-ip-header-name:
               type: str
               description: 'For HTTP multiplexing, enter a custom HTTPS header name. The original client IP address is added to this header. If empty, X-Fo...'
            http-multiplex:
               type: str
               description: 'Enable/disable HTTP multiplexing.'
            https-cookie-secure:
            ...
            persistence:
               type: str
               description: 'Configure how to make sure that clients connect to the same server every time they make a request that is part of the same sess...'
            portforward:
               type: str
               description: 'Enable/disable port forwarding.'
            portmapping-type:
            ...
            realservers:
               ...
               suboptions:
                  ...
                  max-connections:
                     type: int
                     description: 'Max number of active connections that can be directed to the real server. When reached, sessions are sent to other real s...'
                  monitor:
                     type: str
                     description: 'Name of the health check monitor to use when polling to determine a virtual servers connectivity status.'
                  port:
            ...
            ssl-send-empty-frags:
               type: str
               description: 'Enable/disable sending empty fragments to avoid CBC IV attacks (SSL 3.0 & TLS 1.0 only). May need to be disabled for compatibil...'
            ssl-server-algorithm:
               type: str
               description: 'Permitted encryption algorithms for the server side of SSL full mode sessions according to encryption strength.'
            ssl-server-cipher-suites:
