...
DOCUMENTATION = '''
---
module: fmgr_system_ha_monitoredips
short_description: Monitored IP addresses.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ha_monitoredips'),
