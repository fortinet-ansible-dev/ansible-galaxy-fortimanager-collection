...
DOCUMENTATION = '''
---
module: fmgr_firewall_explicitproxyaddrgrp
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Explicit web proxy address group configuration.
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_explicitproxyaddrgrp': {
            ...
            'options': {
                ...
                'member': {'v_range': [['6.2.0', '6.2.12']], 'type': 'str'},
                'name': {'v_range': [['6.2.0', '6.2.12']], 'required': True, 'type': 'str'},
                'tags': {'v_range': [['6.2.0', '6.2.12']], 'type': 'str'},
                'type': {'v_range': [['6.2.0', '6.2.12']], 'choices': ['src', 'dst'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_explicitproxyaddrgrp'),
