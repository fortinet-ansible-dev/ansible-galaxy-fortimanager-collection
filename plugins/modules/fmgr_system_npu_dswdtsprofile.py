...
DOCUMENTATION = '''
---
module: fmgr_system_npu_dswdtsprofile
short_description: Configure NPU DSW DTS profile.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_dswdtsprofile'),
