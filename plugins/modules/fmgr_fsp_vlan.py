                ...
                suboptions:
                    ...
                    dhcp-server:
                        ...
                        suboptions:
                            ...
                            vci-match:
                                type: str
                                description: 'Enable/disable vendor class identifier (VCI) matching. When enabled only DHCP requests with a matching VCI are...'
                                choices:
                                    - 'disable'
                                    - 'enable'
                            vci-string:
            ...
            interface:
                ...
                suboptions:
                    ...
                    device-identification:
                        type: str
                        description: 'Enable/disable passively gathering of device identity information about the devices on the network connected to this i...'
                        choices:
                            - 'disable'
                            - 'enable'
                    ...
                    external:
                        type: str
                        description: 'Enable/disable identifying the interface as an external interface (which usually means its connected to the Internet).'
                        choices:
                            - 'disable'
                            - 'enable'
                    ...
                    forward-error-correction:
                        type: str
                        description: 'Enable/disable forward error correction (FEC Clause 91).'
                        choices:
                            - 'disable'
                            - 'enable'
                            - 'rs-fec'
                    ...
                    switch-controller-feature:
                        type: str
                        description: 'Interfaces purpose when assigning traffic (read only).'
                        choices:
                            - 'none'
                            - 'default-vlan'
                            - 'quarantine'
