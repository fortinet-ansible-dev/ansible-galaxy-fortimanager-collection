...
DOCUMENTATION = '''
---
module: fmgr_wtpprofile_splittunnelingacl
...
def main():
    ...
    module_arg_spec = {
        ...
        'wtpprofile_splittunnelingacl': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'dest-ip': {'type': 'str'}, 'id': {'required': True, 'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wtpprofile_splittunnelingacl'),
