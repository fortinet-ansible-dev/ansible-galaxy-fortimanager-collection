...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_metadata
short_description: Configure meta data.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_metadata'),
