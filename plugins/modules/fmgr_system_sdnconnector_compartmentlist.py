...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_compartmentlist
short_description: Configure OCI compartment list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure OCI compartment list.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_compartmentlist'),
