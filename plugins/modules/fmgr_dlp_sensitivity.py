...
def main():
    ...
    module_arg_spec = {
        ...
        'dlp_sensitivity': {
            'type': 'dict',
            'v_range': [['6.2.0', '']],
            'options': {'name': {'v_range': [['6.2.0', '']], 'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dlp_sensitivity'),
