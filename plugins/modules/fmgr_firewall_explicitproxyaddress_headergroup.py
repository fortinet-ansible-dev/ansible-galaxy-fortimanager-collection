...
DOCUMENTATION = '''
---
module: fmgr_firewall_explicitproxyaddress_headergroup
...
options:
    ...
    explicit-proxy-address:
        description: Deprecated, please use "explicit_proxy_address"
        type: str
    explicit_proxy_address:
        description: The parameter (explicit-proxy-address) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'explicit-proxy-address']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'explicit-proxy-address': {'type': 'str', 'api_name': 'explicit_proxy_address'},
        'explicit_proxy_address': {'type': 'str'},
        'firewall_explicitproxyaddress_headergroup': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_explicitproxyaddress_headergroup'),
