...
DOCUMENTATION = '''
---
module: fmgr_router_accesslist_rule
...
options:
    ...
    adom:
        ...
        required: true
    access-list:
        description: Deprecated, please use "access_list"
        type: str
    access_list:
        description: The parameter (access-list) in requested url.
        type: str
    router_accesslist_rule:
        ...
        suboptions:
            ...
            exact-match:
                type: str
                description: Deprecated, please rename it to exact_match. Enable/disable exact match.
                choices:
                    - 'disable'
                    - 'enable'
            flags:
...
def main():
    ...
    url_params = ['adom', 'access-list']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'access-list': {'type': 'str', 'api_name': 'access_list'},
        ...
        'router_accesslist_rule': {
            ...
            'options': {
                ...
                'exact-match': {'v_range': [['7.0.2', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'flags': {'v_range': [['7.0.2', '']], 'type': 'int'},
                'id': {'v_range': [['7.0.2', '']], 'required': True, 'type': 'int'},
                'prefix': {'v_range': [['7.0.2', '']], 'type': 'str'},
                'wildcard': {'v_range': [['7.0.2', '']], 'type': 'str'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_accesslist_rule'),
