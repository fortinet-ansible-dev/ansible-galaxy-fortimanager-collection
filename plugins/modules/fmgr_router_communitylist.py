...
DOCUMENTATION = '''
---
module: fmgr_router_communitylist
...
options:
    ...
    router_communitylist:
        ...
        suboptions:
            ...
            type:
                type: str
                description: Community list type
                choices:
                    - 'standard'
                    - 'expanded'
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'router_communitylist': {
            ...
            'options': {
                ...
                'type': {'v_range': [['7.0.2', '']], 'choices': ['standard', 'expanded'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_communitylist'),
