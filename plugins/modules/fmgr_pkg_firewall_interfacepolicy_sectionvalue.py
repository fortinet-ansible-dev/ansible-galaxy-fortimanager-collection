...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_interfacepolicy_sectionvalue
...
def main():
    ...
    url_params = ['adom', 'pkg', 'interface-policy']
    module_primary_key = None
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'pkg': {'required': True, 'type': 'str'},
        'interface-policy': {'type': 'str', 'api_name': 'interface_policy'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_interfacepolicy_sectionvalue'),
