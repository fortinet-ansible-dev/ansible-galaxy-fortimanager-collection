...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_qosmap_dscpexcept
short_description: Differentiated Services Code Point (DSCP) exceptions.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_qosmap_dscpexcept'),
