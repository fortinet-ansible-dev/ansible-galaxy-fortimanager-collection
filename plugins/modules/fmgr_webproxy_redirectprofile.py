...
DOCUMENTATION = '''
---
module: fmgr_webproxy_redirectprofile
short_description: Web proxy redirect profile
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Web proxy redirect profile
      fortinet.fortimanager.fmgr_webproxy_redirectprofile:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webproxy_redirectprofile'),
