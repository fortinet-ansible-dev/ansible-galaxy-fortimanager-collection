...
options:
    ...
    dnsfilter_profile_dnstranslation:
        ...
        suboptions:
            dst:
                type: str
                description: 'IPv4 address or subnet on the external network to substitute for the resolved address in DNS query replies. Can be single IP a...'
            id:
                type: int
                description: 'ID.'
            netmask:
            ...
            src:
                type: str
                description: 'IPv4 address or subnet on the internal network to compare with the resolved address in DNS query replies. If the resolved addr...'
            status:
                type: str
            ...
            dst6:
                type: str
                description: 'IPv6 address or subnet on the external network to substitute for the resolved address in DNS query replies. Can be single IP a...'
            prefix:
                type: int
            ...
            src6:
                type: str
                description: 'IPv6 address or subnet on the internal network to compare with the resolved address in DNS query replies. If the resolved addr...'
