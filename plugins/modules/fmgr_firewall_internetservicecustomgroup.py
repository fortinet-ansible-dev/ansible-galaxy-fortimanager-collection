...
DOCUMENTATION = '''
---
module: fmgr_firewall_internetservicecustomgroup
...
options:
    ...
    firewall_internetservicecustomgroup:
        ...
        suboptions:
            ...
            member:
                type: raw
                description: (list or str) Custom Internet Service group members.
            name:
                type: str
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetservicecustomgroup'),
