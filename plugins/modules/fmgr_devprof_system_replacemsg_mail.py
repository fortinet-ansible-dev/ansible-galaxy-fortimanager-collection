...
DOCUMENTATION = '''
---
module: fmgr_devprof_system_replacemsg_mail
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/devprof/{devprof}/system/replacemsg/mail/{mail}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'devprof_system_replacemsg_mail'),
