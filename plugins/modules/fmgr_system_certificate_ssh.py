...
DOCUMENTATION = '''
---
module: fmgr_system_certificate_ssh
...
options:
    ...
    system_certificate_ssh:
        ...
        suboptions:
            ...
            private-key:
                type: raw
                description: (list) Deprecated, please rename it to private_key. SSH private-key
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_certificate_ssh'),
