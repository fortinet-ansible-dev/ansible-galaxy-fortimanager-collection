...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_admin
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the admins of replacement message group
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_admin'),
