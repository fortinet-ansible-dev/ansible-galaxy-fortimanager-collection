...
DOCUMENTATION = '''
---
module: fmgr_firewall_internetserviceaddition_entry_portrange
...
def main():
    ...
    url_params = ['adom', 'internet-service-addition', 'entry']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetserviceaddition_entry_portrange'),
