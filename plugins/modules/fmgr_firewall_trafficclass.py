...
DOCUMENTATION = '''
---
module: fmgr_firewall_trafficclass
short_description: Configure names for shaping classes.
description:
...
options:
    ...
    firewall_trafficclass:
        ...
        suboptions:
            class-id:
                type: int
                description: Deprecated, please rename it to class_id. Class ID to be named.
            class-name:
                type: str
                description: Deprecated, please rename it to class_name. Define the name for this class-id.
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_trafficclass'),
