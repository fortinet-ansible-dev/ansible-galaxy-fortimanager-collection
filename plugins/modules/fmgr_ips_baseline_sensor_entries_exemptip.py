...
DOCUMENTATION = '''
---
module: fmgr_ips_baseline_sensor_entries_exemptip
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ips_baseline_sensor_entries_exemptip'),
