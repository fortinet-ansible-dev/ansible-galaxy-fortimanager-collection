...
DOCUMENTATION = '''
---
module: fmgr_antivirus_notification_entries
short_description: modify this antivirus notification list
description:
...
options:
    ...
    adom:
        ...
        required: true
    notification:
        description: the parameter (notification) in requested url
        type: str
        required: true
   ...
   tasks:
    - name: modify this antivirus notification list
      fmgr_antivirus_notification_entries:
         ...
         rc_failed: [-2, -3, ...]
         adom: <your own value>
         notification: <your own value>
         state: <value in [present, absent]>
         antivirus_notification_entries:
            name: <value of string>
            prefix: <value in [disable, enable]>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_notification_entries'),
