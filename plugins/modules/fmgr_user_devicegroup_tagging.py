...
DOCUMENTATION = '''
---
module: fmgr_user_devicegroup_tagging
 ...
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the object taggings
      fmgr_fact:
        facts:
            selector: 'user_devicegroup_tagging'
            params:
                adom: 'ansible'
                device-group: 'ansible-test' # name
                tagging: ''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_devicegroup_tagging'),
