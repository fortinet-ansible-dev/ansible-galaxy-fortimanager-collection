...
options:
    ...
    system_smsserver:
        ...
        suboptions:
            mail-server:
                type: str
                description: Deprecated, please rename it to mail_server. Email-to-SMS server domain name.
            name:
                type: str
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the SMS servers
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_smsserver': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'mail-server': {'type': 'str'}, 'name': {'required': True, 'type': 'str'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_smsserver'),
