...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_disk_filter
short_description: Filter for disk logging.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/disk/filter/{filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_disk_filter'),
