...
DOCUMENTATION = '''
---
module: fmgr_vpnsslweb_virtualdesktopapplist_apps
...
options:
    ...
    virtual-desktop-app-list:
        description: Deprecated, please use "virtual_desktop_app_list"
        type: str
    virtual_desktop_app_list:
        description: The parameter (virtual-desktop-app-list) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'virtual-desktop-app-list']
    module_primary_key = 'name'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'virtual-desktop-app-list': {'type': 'str', 'api_name': 'virtual_desktop_app_list'},
        'virtual_desktop_app_list': {'type': 'str'},
        'vpnsslweb_virtualdesktopapplist_apps': {
            'type': 'dict',
            'v_range': [['6.2.0', '6.2.13']],
            'options': {
                'md5s': {'v_range': [['6.2.0', '6.2.13']], 'type': 'raw'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnsslweb_virtualdesktopapplist_apps'),
