...
DOCUMENTATION = '''
---
module: fmgr_securityconsole_package_clone
short_description: Clone a policy package within the same ADOM.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/securityconsole/package/clone/{clone}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'securityconsole_package_clone'),
