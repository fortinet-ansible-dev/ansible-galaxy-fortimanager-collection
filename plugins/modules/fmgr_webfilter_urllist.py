...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Webfilter url list
      fortinet.fortimanager.fmgr_webfilter_urllist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_urllist'),
