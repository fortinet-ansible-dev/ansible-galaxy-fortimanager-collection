...
DOCUMENTATION = '''
---
module: fmgr_videofilter_profile_fortiguardcategory_filters
short_description: Configure VideoFilter FortiGuard category.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'videofilter_profile_fortiguardcategory_filters'),
