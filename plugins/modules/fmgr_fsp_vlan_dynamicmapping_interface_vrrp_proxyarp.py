...
DOCUMENTATION = '''
---
module: fmgr_fsp_vlan_dynamicmapping_interface_vrrp_proxyarp
...
def main():
    ...
    url_params = ['adom', 'vlan', 'dynamic_mapping', 'vrrp']
    ...
    module_arg_spec = {
        ...
        'fsp_vlan_dynamicmapping_interface_vrrp_proxyarp': {
            'type': 'dict',
            'v_range': [['7.4.0', '7.4.0']],
            'options': {'id': {'v_range': [['7.4.0', '7.4.0']], 'required': True, 'type': 'int'}, 'ip': {'v_range': [['7.4.0', '7.4.0']], 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'fsp_vlan_dynamicmapping_interface_vrrp_proxyarp'),
