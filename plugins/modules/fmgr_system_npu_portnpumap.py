...
DOCUMENTATION = '''
---
module: fmgr_system_npu_portnpumap
short_description: Configure port to NPU group mapping.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure port to NPU group mapping.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_portnpumap'),
