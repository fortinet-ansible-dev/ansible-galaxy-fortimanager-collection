...
DOCUMENTATION = '''
---
module: fmgr_system_npu_udptimeoutprofile
short_description: Configure UDP timeout profile.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure UDP timeout profile.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_udptimeoutprofile'),
