...
DOCUMENTATION = '''
---
module: fmgr_system_npu_npqueues_scheduler
short_description: Configure a NP7 QoS Scheduler.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure a NP7 QoS Scheduler.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_npqueues_scheduler'),
