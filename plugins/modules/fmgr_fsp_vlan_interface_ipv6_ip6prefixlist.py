...
DOCUMENTATION = '''
---
module: fmgr_fsp_vlan_interface_ipv6_ip6prefixlist
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'fsp_vlan_interface_ipv6_ip6prefixlist'),
