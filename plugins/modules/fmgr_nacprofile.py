...
options:
    ...
    nacprofile:
        ...
        suboptions:
            ...
            onboarding-vlan:
                type: str
                description: Deprecated, please rename it to onboarding_vlan. VLAN interface name.
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'nacprofile': {
            ...
            'options': {
                ...
                'onboarding-vlan': {'v_range': [['7.0.3', '']], 'type': 'str'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'nacprofile'),
