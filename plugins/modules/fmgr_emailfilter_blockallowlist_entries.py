...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_blockallowlist_entries
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Anti-spam block/allow entries.
      fortinet.fortimanager.fmgr_emailfilter_blockallowlist_entries:
        ...
        # rc_failed: [-2, -3, ...]
        adom: <your own value>
        block_allow_list: <your own value>
...
def main():
    ...
    url_params = ['adom', 'block-allow-list']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'block-allow-list': {'type': 'str', 'api_name': 'block_allow_list'},
        'block_allow_list': {'type': 'str'},
        'emailfilter_blockallowlist_entries': {
            'type': 'dict',
            'v_range': [['7.0.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_blockallowlist_entries'),
