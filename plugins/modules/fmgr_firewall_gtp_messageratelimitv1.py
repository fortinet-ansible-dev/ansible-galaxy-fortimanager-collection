...
DOCUMENTATION = '''
---
module: fmgr_firewall_gtp_messageratelimitv1
short_description: Message rate limiting for GTP version 1.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/message-rate-limit-v1/{message-rate-limit-v1}',
        '/pm/config/global/obj/firewall/gtp/{gtp}/message-rate-limit-v1/{message-rate-limit-v1}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_gtp_messageratelimitv1'),
