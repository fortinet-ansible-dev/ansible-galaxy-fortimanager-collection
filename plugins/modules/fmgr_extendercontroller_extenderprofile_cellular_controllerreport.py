...
DOCUMENTATION = '''
---
module: fmgr_extendercontroller_extenderprofile_cellular_controllerreport
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/extender-controller/extender-profile/{extender-profile}/cellular/controller-report/{controller-report}',
        '/pm/config/adom/{adom}/obj/extender-controller/extender-profile/{extender-profile}/cellular/controller-report/{controller-report}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extenderprofile_cellular_controllerreport'),
