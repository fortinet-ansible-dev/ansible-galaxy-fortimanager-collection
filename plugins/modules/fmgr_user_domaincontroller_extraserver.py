...
DOCUMENTATION = '''
---
module: fmgr_user_domaincontroller_extraserver
short_description: extra servers.
description:
...
options:
    ...
    adom:
        ...
        required: true
    domain-controller:
        description: Deprecated, please use "domain_controller"
        type: str
    domain_controller:
        description: The parameter (domain-controller) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'domain-controller']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'domain-controller': {'type': 'str', 'api_name': 'domain_controller'},
        'domain_controller': {'type': 'str'},
        'user_domaincontroller_extraserver': {
            'type': 'dict',
            'v_range': [['6.2.1', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_domaincontroller_extraserver'),
