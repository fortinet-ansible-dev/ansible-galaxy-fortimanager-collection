...
DOCUMENTATION = '''
---
module: fmgr_casb_profile_saasapplication_customcontrol
short_description: CASB profile custom control.
description:
...
- hosts: fortimanager-inventory
  ...
  tasks:
    - name: CASB profile custom control.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'casb_profile_saasapplication_customcontrol'),
