...
DOCUMENTATION = '''
---
module: fmgr_firewall_schedule_group
...
options:
    ...
    firewall_schedule_group:
        ...
        suboptions:
            ...
            member:
                type: raw
                description: (list or str) Schedules added to the schedule group.
            name:
                type: str
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_schedule_group'),
