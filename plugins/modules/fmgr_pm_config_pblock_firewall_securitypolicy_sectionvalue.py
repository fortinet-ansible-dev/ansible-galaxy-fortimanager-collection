...
def main():
    ...
    module_arg_spec = {
        ...
        'pm_config_pblock_firewall_securitypolicy_sectionvalue': {
            'type': 'dict',
            'v_range': [['7.0.3', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']],
            'options': {
                'attr': {'v_range': [['7.0.3', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']], 'choices': ['label', 'global-label'], 'type': 'str'},
                'name': {'v_range': [['7.0.3', '7.2.2'], ['7.2.4', '7.2.4'], ['7.4.2', '']], 'type': 'str'}
            }
