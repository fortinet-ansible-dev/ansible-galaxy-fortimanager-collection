...
options:
    ...
    switchcontroller_qos_qospolicy:
        ...
        suboptions:
            default-cos:
                type: int
                description: Deprecated, please rename it to default_cos. Default cos queue for untagged packets.
            name:
                type: str
            ...
            queue-policy:
                type: str
                description: Deprecated, please rename it to queue_policy. QoS egress queue policy.
            trust-dot1p-map:
                type: str
                description: Deprecated, please rename it to trust_dot1p_map. QoS trust 802.
            trust-ip-dscp-map:
                type: str
                description: Deprecated, please rename it to trust_ip_dscp_map. QoS trust ip dscp map.
'''
