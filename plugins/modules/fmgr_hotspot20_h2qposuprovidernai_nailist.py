...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_h2qposuprovidernai_nailist
...
def main():
    ...
    url_params = ['adom', 'h2qp-osu-provider-nai']
    ...
    module_arg_spec = {
        ...
        'hotspot20_h2qposuprovidernai_nailist': {
            'type': 'dict',
            'v_range': [['7.0.3', '']],
            'options': {'name': {'v_range': [['7.0.3', '']], 'required': True, 'type': 'str'}, 'osu-nai': {'v_range': [['7.0.3', '']], 'type': 'str'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_h2qposuprovidernai_nailist'),
