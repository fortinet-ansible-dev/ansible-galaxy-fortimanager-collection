...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_acl_ingress_action
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/switch-controller/acl/ingress/{ingress}/action/{action}',
        '/pm/config/global/obj/switch-controller/acl/ingress/{ingress}/action/{action}'
    ]
