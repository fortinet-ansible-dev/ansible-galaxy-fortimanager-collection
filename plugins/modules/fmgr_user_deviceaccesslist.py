...
options:
    ...
    user_deviceaccesslist:
        ...
        suboptions:
            default-action:
                type: str
                description: Deprecated, please rename it to default_action. Accept or deny unknown/unspecified devices.
                choices:
                    - 'deny'
                    - 'accept'
            device-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to device_list. Device list.
                suboptions:
                    action:
                        type: str
