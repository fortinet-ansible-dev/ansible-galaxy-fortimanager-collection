    ...
    cloud_orchestawstemplate_autoscaleexistingvpc:
        ...
        suboptions:
            ...
            private-subnet-route-table:
                type: str
                description: Deprecated, please rename it to private_subnet_route_table. Private subnet route table.
            private-subnet1:
                type: str
                description: Deprecated, please rename it to private_subnet1. Private subnet1.
            private-subnet2:
                type: str
                description: Deprecated, please rename it to private_subnet2. Private subnet2.
            public-subnet1:
                type: str
                description: Deprecated, please rename it to public_subnet1. Public subnet1.
            public-subnet2:
                type: str
                description: Deprecated, please rename it to public_subnet2. Public subnet2.
            resource-tag-prefix:
                type: str
            ...
            vpc-endpoint-id:
                type: str
                description: Deprecated, please rename it to vpc_endpoint_id. Vpc endpoint id.
            vpc-id:
                type: str
                description: Deprecated, please rename it to vpc_id. Vpc id.
'''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cloud_orchestawstemplate_autoscaleexistingvpc'),
