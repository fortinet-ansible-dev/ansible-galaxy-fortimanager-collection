    ...
    cloud_orchestawstemplate_autoscaleexistingvpc:
        ...
        suboptions:
            ...
            private-subnet-route-table:
                type: str
                description: Deprecated, please rename it to private_subnet_route_table.
            private-subnet1:
                type: str
                description: Deprecated, please rename it to private_subnet1.
            private-subnet2:
                type: str
                description: Deprecated, please rename it to private_subnet2.
            public-subnet1:
                type: str
                description: Deprecated, please rename it to public_subnet1.
            public-subnet2:
                type: str
                description: Deprecated, please rename it to public_subnet2.
            resource-tag-prefix:
                type: str
            ...
            vpc-endpoint-id:
                type: str
                description: Deprecated, please rename it to vpc_endpoint_id.
            vpc-id:
                type: str
                description: Deprecated, please rename it to vpc_id.
'''
