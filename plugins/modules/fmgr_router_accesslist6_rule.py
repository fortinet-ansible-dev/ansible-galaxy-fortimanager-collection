...
DOCUMENTATION = '''
---
module: fmgr_router_accesslist6_rule
...
options:
    ...
    adom:
        ...
        required: true
    access-list6:
        description: Deprecated, please use "access_list6"
        type: str
    access_list6:
        description: The parameter (access-list6) in requested url.
        type: str
    router_accesslist6_rule:
        ...
        suboptions:
            ...
            exact-match:
                type: str
                description: Deprecated, please rename it to exact_match. Enable/disable exact prefix match.
                choices:
                    - 'disable'
                    - 'enable'
            flags:
...
def main():
    ...
    url_params = ['adom', 'access-list6']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'access-list6': {'type': 'str', 'api_name': 'access_list6'},
        'access_list6': {'type': 'str'},
        'router_accesslist6_rule': {
            'type': 'dict',
            'v_range': [['7.0.2', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_accesslist6_rule'),
