...
DOCUMENTATION = '''
---
module: fmgr_system_metadata_admins
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the admins
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "system_metadata_admins"
          params:
            admins: "your_value"
'''
...
def main():
    ...
    url_params = []
    module_primary_key = 'fieldname'
    module_arg_spec = {
        'system_metadata_admins': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {
                'fieldlength': {'choices': ['20', '50', '255'], 'type': 'str'},
                'fieldname': {'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_metadata_admins'),
