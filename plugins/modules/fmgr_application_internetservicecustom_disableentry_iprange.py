...
DOCUMENTATION = '''
---
module: fmgr_application_internetservicecustom_disableentry_iprange
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'application_internetservicecustom_disableentry_iprange'),
