...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/webfilter/profile/{profile}/file-filter/{file-filter}',
        '/pm/config/adom/{adom}/obj/webfilter/profile/{profile}/file-filter/{file-filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_profile_filefilter'),
