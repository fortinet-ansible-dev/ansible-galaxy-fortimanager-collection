...
DOCUMENTATION = '''
---
module: fmgr_pkg_footer_policy_identitybasedpolicy
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: no description
      fmgr_pkg_footer_policy_identitybasedpolicy:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_footer_policy_identitybasedpolicy'),
