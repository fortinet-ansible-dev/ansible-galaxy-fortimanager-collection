...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_routetable_route
short_description: Configure Azure route.
description:
...
options:
    ...
    sdn_connector:
        ...
        type: str
    route-table:
        description: Deprecated, please use "route_table"
        type: str
    route_table:
        description: The parameter (route-table) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'sdn-connector', 'route-table']
    ...
    module_arg_spec = {
        ...
        'system_sdnconnector_routetable_route': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'name': {'required': True, 'type': 'str'}, 'next-hop': {'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_routetable_route'),
