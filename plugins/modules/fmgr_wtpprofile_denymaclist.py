...
DOCUMENTATION = '''
---
module: fmgr_wtpprofile_denymaclist
...
def main():
    ...
    module_arg_spec = {
        ...
        'wtpprofile_denymaclist': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'id': {'required': True, 'type': 'int'}, 'mac': {'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wtpprofile_denymaclist'),
