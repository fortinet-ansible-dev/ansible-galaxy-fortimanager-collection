...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_routetable
short_description: Configure Azure route table.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_routetable'),
