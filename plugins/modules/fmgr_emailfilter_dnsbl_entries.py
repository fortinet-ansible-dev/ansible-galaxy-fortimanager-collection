...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_dnsbl_entries
short_description: Spam filter DNSBL and ORBL server.
description:
...
options:
    ...
    adom:
        ...
        required: true
    dnsbl:
        description: the parameter (dnsbl) in requested url
        type: str
        required: true
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_dnsbl_entries'),
