...
DOCUMENTATION = '''
---
module: fmgr_system_autodelete_dlpfilesautodeletion
short_description: Automatic deletion policy for DLP archives.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autodelete_dlpfilesautodeletion'),
