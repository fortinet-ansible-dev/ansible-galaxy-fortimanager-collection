...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_memory_filter
short_description: Filter for memory logging.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/memory/filter/{filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_memory_filter'),
