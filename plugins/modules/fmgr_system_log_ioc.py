...
def main():
    ...
    module_arg_spec = {
        'system_log_ioc': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'notification': {'choices': ['disable', 'enable'], 'type': 'str'},
                'notification-throttle': {'type': 'int'},
                'rescan-max-runner': {'type': 'int'},
                'rescan-run-at': {'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_log_ioc'),
