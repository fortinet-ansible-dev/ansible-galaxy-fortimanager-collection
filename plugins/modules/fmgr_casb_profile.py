        ...
        casb_profile:
          ...
          saas-application:
            -
              ...
              domain-control: <value in [disable, enable]>
              domain-control-domains: <list or string>
              log: <value in [disable, enable]>
              name: <string>
              safe-search: <value in [disable, enable]>
              safe-search-control: <list or string>
              tenant-control: <value in [disable, enable]>
              tenant-control-tenants: <list or string>
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'casb_profile'),
