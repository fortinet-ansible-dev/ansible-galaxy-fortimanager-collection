...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_syslogd3_filter
short_description: Filter for syslog logging.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/syslogd3/filter/{filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_syslogd3_filter'),
