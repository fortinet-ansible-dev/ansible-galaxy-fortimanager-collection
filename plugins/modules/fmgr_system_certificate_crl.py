...
options:
    ...
    system_certificate_crl:
        ...
        suboptions:
            ...
            http-url:
                type: str
                description: Deprecated, please rename it to http_url. HTTP server URL for CRL auto-update
            update-interval:
                type: int
                description: Deprecated, please rename it to update_interval. CRL auto-update interval
'''
