...
DOCUMENTATION = '''
---
module: fmgr_system_npu_npqueues_ipservice
short_description: Configure a NP7 QoS IP Service.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure a NP7 QoS IP Service.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_npqueues_ipservice'),
