...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_h2qposuprovidernai
    ...
    hotspot20_h2qposuprovidernai:
        ...
        suboptions:
            nai-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to nai_list.
                suboptions:
                    name:
                        type: str
...
def main():
        ...
        'hotspot20_h2qposuprovidernai': {
            ...
            'options': {
                'nai-list': {
                    'v_range': [['7.0.3', '']],
                    'type': 'list',
                    'options': {'name': {'v_range': [['7.0.3', '']], 'type': 'str'}, 'osu-nai': {'v_range': [['7.0.3', '']], 'type': 'str'}},
                    'elements': 'dict'
                },
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_h2qposuprovidernai'),
