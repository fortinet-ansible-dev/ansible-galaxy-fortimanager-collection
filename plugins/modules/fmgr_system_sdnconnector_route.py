...
DOCUMENTATION = '''
---
module: fmgr_system_sdnconnector_route
short_description: Configure GCP route.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdnconnector_route'),
