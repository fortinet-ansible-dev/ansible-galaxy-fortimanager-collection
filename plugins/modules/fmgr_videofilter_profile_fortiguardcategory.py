...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/videofilter/profile/{profile}/fortiguard-category/{fortiguard-category}',
        '/pm/config/global/obj/videofilter/profile/{profile}/fortiguard-category/{fortiguard-category}'
    ]
