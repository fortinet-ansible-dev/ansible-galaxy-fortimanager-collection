...
DOCUMENTATION = '''
---
module: fmgr_telemetrycontroller_agentprofile
short_description: Configure FortiTelemetry agent profiles.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiTelemetry agent profiles.
      fortinet.fortimanager.fmgr_telemetrycontroller_agentprofile:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'telemetrycontroller_agentprofile'),
