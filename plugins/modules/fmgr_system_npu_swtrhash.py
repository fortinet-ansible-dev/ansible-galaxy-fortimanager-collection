...
DOCUMENTATION = '''
---
module: fmgr_system_npu_swtrhash
short_description: Configure switch traditional hashing.
description:
...
options:
    ...
    system_npu_swtrhash:
        ...
        suboptions:
            ...
            tcp-udp-port:
                type: str
                description: Deprecated, please rename it to tcp_udp_port. Include/exclude TCP/UDP source and destination port for unicast trunk traffic.
                choices:
                    - 'include'
                    - 'exclude'
'''
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure switch traditional hashing.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_swtrhash'),
