...
DOCUMENTATION = '''
---
module: fmgr_sys_login_challenge
...
def main():
    ...
    module_arg_spec = {
        'sys_login_challenge': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'answer': {'type': 'str'}, 'session': {'type': 'str'}}
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'sys_login_challenge'),
