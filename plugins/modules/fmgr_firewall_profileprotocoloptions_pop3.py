...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_pop3
short_description: Configure POP3 protocol options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}/pop3/{pop3}',
        '/pm/config/global/obj/firewall/profile-protocol-options/{profile-protocol-options}/pop3/{pop3}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_pop3'),
