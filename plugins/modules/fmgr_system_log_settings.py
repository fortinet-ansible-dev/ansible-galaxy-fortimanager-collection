...
options:
    ...
    system_log_settings:
        ...
        suboptions:
            ...
            rolling-analyzer:
                type: dict
                description: Deprecated, please rename it to rolling_analyzer.
                suboptions:
                    days:
                        type: list
                        elements: str
            ...
            rolling-local:
                type: dict
                description: Deprecated, please rename it to rolling_local.
                suboptions:
                    days:
                        type: list
                        elements: str
            ...
            rolling-regular:
                type: dict
                description: Deprecated, please rename it to rolling_regular.
                suboptions:
                    days:
                        type: list
                        elements: str
