...
DOCUMENTATION = '''
---
module: fmgr_webfilter_ftgdlocalrating
...
options:
    ...
    webfilter_ftgdlocalrating:
        ...
        suboptions:
            rating:
                type: raw
                description: (list or str) Local rating.
                required: true
            status:
                type: str
...
def main():
    ...
    module_arg_spec = {
        ...
        'webfilter_ftgdlocalrating': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'rating': {'required': True, 'type': 'raw'},
                'status': {'choices': ['disable', 'enable'], 'type': 'str'},
                'url': {'type': 'str'},
                'comment': {'v_range': [['6.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_ftgdlocalrating'),
