...
options:
    ...
    system_admin_radius:
        ...
        suboptions:
            ...
            nas-ip:
                type: str
                description: Deprecated, please rename it to nas_ip. NAS IP address and called station ID.
            port:
                type: int
                description: Server port.
            secondary-secret:
                type: raw
                description: (list) Deprecated, please rename it to secondary_secret. Secondary server secret.
            secondary-server:
                type: str
                description: Deprecated, please rename it to secondary_server. Secondary server name/IP.
            secret:
                type: raw
