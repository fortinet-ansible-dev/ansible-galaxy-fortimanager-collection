...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_memory_setting
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/memory/setting/{setting}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_memory_setting'),
