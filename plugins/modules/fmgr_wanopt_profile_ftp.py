...
DOCUMENTATION = '''
---
module: fmgr_wanopt_profile_ftp
short_description: Enable/disable FTP WAN Optimization and configure FTP WAN Optimization features.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/wanopt/profile/{profile}/ftp/{ftp}',
        '/pm/config/global/obj/wanopt/profile/{profile}/ftp/{ftp}'
    ]
    ...
    module_arg_spec = {
        ...
        'wanopt_profile_ftp': {
            ...
            'options': {
                ...
                'ssl': {'v_range': [['6.4.0', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanopt_profile_ftp'),
