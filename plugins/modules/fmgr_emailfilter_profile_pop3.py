...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_profile_pop3
short_description: POP3.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/emailfilter/profile/{profile}/pop3/{pop3}',
        '/pm/config/adom/{adom}/obj/emailfilter/profile/{profile}/pop3/{pop3}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_profile_pop3'),
