...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_maxcookie
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Maximum number of cookies in HTTP request.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/max-cookie/{max-cookie}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/max-cookie/{max-cookie}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_maxcookie'),
