...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_anqpnetworkauthtype
...
options:
    ...
    hotspot20_anqpnetworkauthtype:
        ...
        suboptions:
            auth-type:
                type: str
                description: Deprecated, please rename it to auth_type. Network authentication type.
                choices:
                    - 'acceptance-of-terms'
                    - 'online-enrollment'
                    - 'http-redirection'
...
def main():
    ...
    module_arg_spec = {
        ...
        'hotspot20_anqpnetworkauthtype': {
            ...
            'v_range': [['6.0.0', '']],
            'options': {
                'auth-type': {'choices': ['acceptance-of-terms', 'online-enrollment', 'http-redirection', 'dns-redirection'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_anqpnetworkauthtype'),
