...
options:
    ...
    webproxy_wisp:
        ...
        suboptions:
            ...
            max-connections:
                type: int
                description: Deprecated, please rename it to max_connections. Maximum number of web proxy WISP connections
            name:
                type: str
            ...
            outgoing-ip:
                type: str
                description: Deprecated, please rename it to outgoing_ip. WISP outgoing IP address.
            server-ip:
                type: str
                description: Deprecated, please rename it to server_ip. WISP server IP address.
            server-port:
                type: int
                description: Deprecated, please rename it to server_port. WISP server port
            timeout:
                type: int
