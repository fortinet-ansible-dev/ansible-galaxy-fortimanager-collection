...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_auth
 ...
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the scripts
      fmgr_fact:
        facts:
            selector: 'system_replacemsggroup_auth'
            params:
                adom: 'ansible'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_auth'),
