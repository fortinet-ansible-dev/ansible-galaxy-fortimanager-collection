...
options:
    ...
    fmg_sasemanager_settings:
        ...
        suboptions:
            ...
            sync-address:
                type: str
                description: Deprecated, please rename it to sync_address. Sync address.
                choices:
                    - 'disable'
                    - 'specify'
                    - 'all'
            sync-profile-group:
                type: str
                description: Deprecated, please rename it to sync_profile_group. Sync profile group.
                choices:
                    - 'disable'
                    - 'specify'
                    - 'all'
            sync-user:
                type: str
                description: Deprecated, please rename it to sync_user. Sync user.
                choices:
                    - 'disable'
                    - 'specify'
                    - 'all'
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/fmg/sase-manager/settings/{settings}',
        '/pm/config/global/obj/fmg/sase-manager/settings/{settings}'
    ]
