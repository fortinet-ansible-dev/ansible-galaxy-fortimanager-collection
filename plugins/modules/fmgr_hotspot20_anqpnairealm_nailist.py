...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_anqpnairealm_nailist
    ...
    hotspot20_anqpnairealm_nailist:
        ...
        suboptions:
            eap-method:
                type: list
                elements: dict
                description: Deprecated, please rename it to eap_method.
                suboptions:
                    auth-param:
                        type: list
                        elements: dict
                        description: Deprecated, please rename it to auth_param.
                        suboptions:
                            id:
                                type: str
...
def main():
    ...
    url_params = ['adom', 'anqp-nai-realm']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_anqpnairealm_nailist'),
