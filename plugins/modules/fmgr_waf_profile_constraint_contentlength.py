...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_contentlength
short_description: HTTP content length in request.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/content-length/{content-length}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/content-length/{content-length}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_contentlength'),
