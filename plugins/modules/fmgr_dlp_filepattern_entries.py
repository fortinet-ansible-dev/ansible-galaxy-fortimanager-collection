...
DOCUMENTATION = '''
---
module: fmgr_dlp_filepattern_entries
...
options:
    ...
    adom:
        ...
        required: true
    filepattern:
        description: The parameter (filepattern) in requested url.
        type: str
        required: true
    dlp_filepattern_entries:
        ...
        suboptions:
            file-type:
                type: str
                description: Deprecated, please rename it to file_type. Select a file type.
                choices:
                    - 'unknown'
                    - 'ignored'
                    - 'exe'
...
def main():
    ...
    url_params = ['adom', 'filepattern']
    module_primary_key = None
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'filepattern': {'required': True, 'type': 'str'},
        'dlp_filepattern_entries': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dlp_filepattern_entries'),
