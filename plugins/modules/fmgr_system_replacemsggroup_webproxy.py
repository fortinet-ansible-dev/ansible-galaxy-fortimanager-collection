...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_webproxy
...
EXAMPLES = '''
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the webproxys of replacement message group
      fmgr_fact:
        facts:
            selector: 'system_replacemsggroup_webproxy'
            params:
                adom: 'ansible'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_webproxy'),
