...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pblock_firewall_proxypolicy_sectionvalue
...
options:
    ...
    pblock:
        ...
        required: true
    proxy-policy:
        description: Deprecated, please use "proxy_policy"
        type: str
    proxy_policy:
        description: The parameter (proxy-policy) in requested url.
        type: str
...
def main():
    urls_list = [
        '/pm/config/adom/{adom}/pblock/{pblock}/firewall/proxy-policy/{proxy-policy}/section value'
    ]
    url_params = ['adom', 'pblock', 'proxy-policy']
    ...
    module_arg_spec = {
        ...
        'pm_config_pblock_firewall_proxypolicy_sectionvalue': {
            ...
            'v_range': [['7.6.0', '']],
            'options': {
                'attr': {'v_range': [['7.6.0', '']], 'choices': ['label', 'global-label'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_pblock_firewall_proxypolicy_sectionvalue'),
