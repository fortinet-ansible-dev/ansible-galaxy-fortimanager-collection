...
DOCUMENTATION = '''
---
module: fmgr_system_npu_portcpumap
short_description: Configure NPU interface to CPU core mapping.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure NPU interface to CPU core mapping.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_portcpumap'),
