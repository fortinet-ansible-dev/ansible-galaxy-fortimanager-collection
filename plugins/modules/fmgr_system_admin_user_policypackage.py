...
DOCUMENTATION = '''
---
module: fmgr_system_admin_user_policypackage
short_description: Policy package access.
description:
...
def main():
    ...
    url_params = ['user']
    module_primary_key = 'policy-package-name'
    module_arg_spec = {
        'user': {'required': True, 'type': 'str'},
        'system_admin_user_policypackage': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'policy-package-name': {'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_user_policypackage'),
