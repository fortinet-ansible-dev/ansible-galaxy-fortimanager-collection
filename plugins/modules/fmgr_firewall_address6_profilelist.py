...
DOCUMENTATION = '''
---
module: fmgr_firewall_address6_profilelist
short_description: List of NSX service profiles that use this address.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: List of NSX service profiles that use this address.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_address6_profilelist'),
