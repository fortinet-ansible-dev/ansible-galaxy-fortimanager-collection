...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pblock_firewall_consolidated_policy_sectionvalue
...
def main():
    urls_list = [
        '/pm/config/adom/{adom}/pblock/{pblock}/firewall/consolidated/policy/{policy}/section value'
    ]
    url_params = ['adom', 'pblock', 'policy']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_pblock_firewall_consolidated_policy_sectionvalue'),
