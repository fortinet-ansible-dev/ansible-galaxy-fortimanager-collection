...
DOCUMENTATION = '''
---
module: fmgr_pkg_header_policy6_identitybasedpolicy6
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: no description
      fmgr_pkg_header_policy6_identitybasedpolicy6:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_header_policy6_identitybasedpolicy6'),
