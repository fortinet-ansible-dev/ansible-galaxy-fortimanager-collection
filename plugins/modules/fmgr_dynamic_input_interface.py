...
options:
    ...
    dynamic_input_interface:
        ...
        suboptions:
            default-mapping:
                type: str
                description: Deprecated, please rename it to default_mapping.
                choices:
                    - 'disable'
                    - 'enable'
            defmap-intf:
                type: str
                description: Deprecated, please rename it to defmap_intf.
            description:
                type: str
            ...
            dynamic_mapping:
                ...
                suboptions:
                    ...
                    local-intf:
                        type: str
                        description: Deprecated, please rename it to local_intf.
            name:
                type: str
                description: No description.
                required: true
            skip-unmapped:
                type: str
                description: Deprecated, please rename it to skip_unmapped.
                choices:
                    - 'disable'
                    - 'enable'
'''
...
def main():
                ...
                'dynamic_mapping': {
                    ...
                    'options': {
                        '_scope': {
                            ...
                            'type': 'list',
                            'options': {
                                'name': {'v_range': [['6.2.2', '6.4.0']], 'type': 'str'},
                                'vdom': {'v_range': [['6.2.2', '6.4.0']], 'type': 'str'}
                            },
                            'elements': 'dict'
                        },
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dynamic_input_interface'),
