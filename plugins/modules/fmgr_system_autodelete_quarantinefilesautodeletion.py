...
DOCUMENTATION = '''
---
module: fmgr_system_autodelete_quarantinefilesautodeletion
short_description: Automatic deletion policy for quarantined files.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/auto-delete/quarantine-files-auto-deletion/{quarantine-files-auto-deletion}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autodelete_quarantinefilesautodeletion'),
