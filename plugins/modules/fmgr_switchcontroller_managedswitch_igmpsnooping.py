...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_managedswitch_igmpsnooping
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/device/{device}/vdom/{vdom}/switch-controller/managed-switch/{managed-switch}/igmp-snooping/{igmp-snooping}'
    ]
