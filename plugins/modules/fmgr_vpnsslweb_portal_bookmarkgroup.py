        ...
        suboptions:
            bookmarks:
                ...
                suboptions:
                    ...
                    load-balancing-info:
                        type: str
                        description: Deprecated, please rename it to load_balancing_info. The load balancing information or cookie which should be prov...
                    logon-password:
                        type: raw
                    ...
                    sso-credential-sent-once:
                        type: str
                        description: Deprecated, please rename it to sso_credential_sent_once. Single sign-on credentials are only sent once to remote ...
                        choices:
                            - 'disable'
                            - 'enable'
                    sso-password:
