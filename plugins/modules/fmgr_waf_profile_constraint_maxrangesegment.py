...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_maxrangesegment
short_description: Maximum number of range segments in HTTP range line.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/max-range-segment/{max-range-segment}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/max-range-segment/{max-range-segment}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_maxrangesegment'),
