...
DOCUMENTATION = '''
---
module: fmgr_webfilter_contentheader
...
def main():
        ...
        'webfilter_contentheader': {
            ...
            'options': {
                ...
                'entries': {
                    'type': 'list',
                    'options': {
                        'action': {'choices': ['exempt', 'block', 'allow'], 'type': 'str'},
                        'category': {'type': 'raw'},
                        'pattern': {'type': 'str'}
                    },
                    'elements': 'dict'
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_contentheader'),
