...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_nntp
short_description: Configure NNTP AntiVirus options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/nntp/{nntp}',
        '/pm/config/global/obj/antivirus/profile/{profile}/nntp/{nntp}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_nntp'),
