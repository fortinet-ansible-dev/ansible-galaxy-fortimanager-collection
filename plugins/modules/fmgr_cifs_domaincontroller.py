...
DOCUMENTATION = '''
---
module: fmgr_cifs_domaincontroller
...
options:
    ...
    cifs_domaincontroller:
        ...
        suboptions:
            domain-name:
                type: str
                description: Deprecated, please rename it to domain_name. Fully qualified domain name
            ip:
                type: str
            ...
            server-name:
                type: str
                description: Deprecated, please rename it to server_name. Name of the server to connect to.
            username:
                type: str
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cifs_domaincontroller'),
