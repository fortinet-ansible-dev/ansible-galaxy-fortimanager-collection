...
DOCUMENTATION = '''
---
module: fmgr_firewall_profileprotocoloptions_dns
short_description: Configure DNS protocol options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}/dns/{dns}',
        '/pm/config/global/obj/firewall/profile-protocol-options/{profile-protocol-options}/dns/{dns}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_profileprotocoloptions_dns'),
