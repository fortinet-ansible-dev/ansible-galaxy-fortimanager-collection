...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_dnsbl
short_description: Configure AntiSpam DNSBL/ORBL.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_dnsbl'),
