...
DOCUMENTATION = '''
---
module: fmgr_wanopt_profile_obj
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                auth-group:
                    type: str
                    description: 'Optionally add an authentication group to restrict access to the WAN Optimization tunnel to peers in the authentication gr...'
                comments:
                    type: str
                    description: 'Comment.'
                name:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/wanopt/profile/{profile}'
return_of_api_category_0:
