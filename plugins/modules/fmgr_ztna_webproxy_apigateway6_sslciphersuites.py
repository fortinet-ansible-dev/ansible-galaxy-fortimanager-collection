...
DOCUMENTATION = '''
---
module: fmgr_ztna_webproxy_apigateway6_sslciphersuites
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSL/TLS cipher suites to offer to a server, ordered by priority.
      fortinet.fortimanager.fmgr_ztna_webproxy_apigateway6_sslciphersuites:
...
def main():
    ...
    url_params = ['adom', 'web-proxy', 'api-gateway6']
    ...
    module_arg_spec = {
        ...
        'ztna_webproxy_apigateway6_sslciphersuites': {
            ...
            'options': {
                ...
                'versions': {'v_range': [['7.6.4', '']], 'type': 'list', 'choices': ['tls-1.0', 'tls-1.1', 'tls-1.2', 'tls-1.3'], 'elements': 'str'}
            }
        }
    }
