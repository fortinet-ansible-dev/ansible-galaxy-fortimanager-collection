        ...
        suboptions:
            ...
            ip-range:
                ...
                suboptions:
                        ...
                        type: str
                        description: Deprecated, please rename it to end_ip. Final IP address, inclusive, of the address range
                    id:
                        type: int
            ...
            ip6-range:
                type: list
                elements: dict
                description: Deprecated, please rename it to ip6_range. Ip6 range.
                suboptions:
                    end-ip:
                        type: str
