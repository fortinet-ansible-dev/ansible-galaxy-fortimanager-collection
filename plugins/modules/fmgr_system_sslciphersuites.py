...
DOCUMENTATION = '''
---
module: fmgr_system_sslciphersuites
short_description: Configure preferred SSL/TLS cipher suites
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sslciphersuites'),
