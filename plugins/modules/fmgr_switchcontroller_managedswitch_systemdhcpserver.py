...
DOCUMENTATION = '''
---
module: fmgr_switchcontroller_managedswitch_systemdhcpserver
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DHCP servers.
      fortinet.fortimanager.fmgr_switchcontroller_managedswitch_systemdhcpserver:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_systemdhcpserver'),
