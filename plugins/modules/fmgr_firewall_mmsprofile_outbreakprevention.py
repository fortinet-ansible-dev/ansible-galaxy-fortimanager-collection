...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/firewall/mms-profile/{mms-profile}/outbreak-prevention/{outbreak-prevention}',
        '/pm/config/adom/{adom}/obj/firewall/mms-profile/{mms-profile}/outbreak-prevention/{outbreak-prevention}'
    ]
