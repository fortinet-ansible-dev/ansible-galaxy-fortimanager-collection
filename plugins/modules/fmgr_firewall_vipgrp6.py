...
DOCUMENTATION = '''
---
module: fmgr_firewall_vipgrp6
short_description: Configure IPv6 virtual IP groups.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_vipgrp6'),
