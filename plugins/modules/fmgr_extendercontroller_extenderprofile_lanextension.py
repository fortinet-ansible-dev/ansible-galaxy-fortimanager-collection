...
DOCUMENTATION = '''
---
module: fmgr_extendercontroller_extenderprofile_lanextension
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/extender-controller/extender-profile/{extender-profile}/lan-extension/{lan-extension}',
        '/pm/config/adom/{adom}/obj/extender-controller/extender-profile/{extender-profile}/lan-extension/{lan-extension}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extenderprofile_lanextension'),
