...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_nacquar
short_description: Configure AntiVirus quarantine settings.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/nac-quar/{nac-quar}',
        '/pm/config/global/obj/antivirus/profile/{profile}/nac-quar/{nac-quar}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_nacquar'),
