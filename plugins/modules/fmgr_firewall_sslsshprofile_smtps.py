...
DOCUMENTATION = '''
---
module: fmgr_firewall_sslsshprofile_smtps
short_description: Configure SMTPS options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/smtps/{smtps}',
        '/pm/config/global/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/smtps/{smtps}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_sslsshprofile_smtps'),
