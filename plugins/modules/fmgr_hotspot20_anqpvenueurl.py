...
DOCUMENTATION = '''
---
module: fmgr_hotspot20_anqpvenueurl
    ...
    hotspot20_anqpvenueurl:
        ...
        suboptions:
            ...
            value-list:
                type: list
                elements: dict
                description: Deprecated, please rename it to value_list. Value list.
                suboptions:
                    index:
                        type: int
...
def main():
        ...
        'hotspot20_anqpvenueurl': {
            ...
            'options': {
                ...
                'value-list': {
                    ...
                    'type': 'list',
                    'options': {
                        'index': {'v_range': [['7.0.3', '']], 'type': 'int'},
                        'number': {'v_range': [['7.0.3', '']], 'type': 'int'},
                        'value': {'v_range': [['7.0.3', '']], 'type': 'str'}
                    },
                    'elements': 'dict'
                }
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'hotspot20_anqpvenueurl'),
