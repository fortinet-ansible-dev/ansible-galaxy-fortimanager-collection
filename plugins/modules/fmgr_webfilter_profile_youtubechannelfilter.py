...
DOCUMENTATION = '''
---
module: fmgr_webfilter_profile_youtubechannelfilter
short_description: YouTube channel filter.
description:
...
def main():
    ...
    module_arg_spec = {
        ...
        'webfilter_profile_youtubechannelfilter': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'channel-id': {'type': 'str'}, 'comment': {'type': 'str'}, 'id': {'required': True, 'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_profile_youtubechannelfilter'),
