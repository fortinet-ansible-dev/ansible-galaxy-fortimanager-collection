...
DOCUMENTATION = '''
---
module: fmgr_system_npu_ssehascan
short_description: Configure driver HA scan for SSE.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_npu_ssehascan'),
