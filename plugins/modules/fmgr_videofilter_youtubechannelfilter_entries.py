...
DOCUMENTATION = '''
---
module: fmgr_videofilter_youtubechannelfilter_entries
...
options:
    ...
    youtube-channel-filter:
        description: Deprecated, please use "youtube_channel_filter"
        type: str
    youtube_channel_filter:
        description: The parameter (youtube-channel-filter) in requested url.
        type: str
...
def main():
    ...
    url_params = ['adom', 'youtube-channel-filter']
    module_primary_key = 'id'
    module_arg_spec = {
        'adom': {'required': True, 'type': 'str'},
        'youtube-channel-filter': {'type': 'str', 'api_name': 'youtube_channel_filter'},
        'youtube_channel_filter': {'type': 'str'},
        'videofilter_youtubechannelfilter_entries': {
            'type': 'dict',
            'v_range': [['7.0.0', '']],
            'options': {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'videofilter_youtubechannelfilter_entries'),
