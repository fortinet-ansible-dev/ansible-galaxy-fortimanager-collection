...
DOCUMENTATION = '''
---
module: fmgr_waf_profile_constraint_maxheaderline
short_description: Maximum number of HTTP header line.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/max-header-line/{max-header-line}',
        '/pm/config/global/obj/waf/profile/{profile}/constraint/max-header-line/{max-header-line}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'waf_profile_constraint_maxheaderline'),
