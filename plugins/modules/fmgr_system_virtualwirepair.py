...
DOCUMENTATION = '''
---
module: fmgr_system_virtualwirepair
...
options:
    ...
    system_virtualwirepair:
        ...
        suboptions:
            ...
            wildcard-vlan:
                type: str
                description: Deprecated, please rename it to wildcard_vlan. Enable/disable wildcard VLAN.
                choices:
                    - 'disable'
                    - 'enable'
            poweron-bypass:
                type: str
                description: Deprecated, please rename it to poweron_bypass. Set interface bypass state in power on
                choices:
                    - 'disable'
                    - 'enable'
            poweroff-bypass:
                type: str
                description: Deprecated, please rename it to poweroff_bypass. Set interface bypass state in power off
                choices:
                    - 'disable'
                    - 'enable'
            outer-vlan-id:
                type: raw
                description: (list) Deprecated, please rename it to outer_vlan_id. Outer VLAN ID.
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_virtualwirepair': {
            ...
            'options': {
                ...
                'wildcard-vlan': {'choices': ['disable', 'enable'], 'type': 'str'},
                'poweron-bypass': {'v_range': [['6.2.7', '6.2.12'], ['6.4.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'poweroff-bypass': {'v_range': [['6.2.7', '6.2.12'], ['6.4.4', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'outer-vlan-id': {'v_range': [['7.2.3', '']], 'type': 'raw'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_virtualwirepair'),
