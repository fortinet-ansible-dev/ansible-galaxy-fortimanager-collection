...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsggroup_devicedetectionportal
...
EXAMPLES = '''
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the device detection portals of replacement message group
      fmgr_fact:
        facts:
            selector: 'system_replacemsggroup_devicedetectionportal'
            params:
                adom: 'ansible'
                replacemsg-group: 'ansible-test' # name
                device-detection-portal: 'your_value'
 - hosts: fortimanager00
   collections:
     - fortinet.fortimanager
   connection: httpapi
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsggroup_devicedetectionportal'),
