...
options:
    ...
    pm_config_reset_database:
        ...
        suboptions:
            ...
            version:
                type: int
                description: Integer major release value
'''
...
def main():
    jrpc_urls = [
        '/pm/config/global/_reset/database'
    ]

    perobject_jrpc_urls = [
        '/pm/config/global/_reset/database/{database}'
    ]
    ...
    module_arg_spec = {
        'pm_config_reset_database': {
            ...
            'options': {
                'mr': {'v_range': [['6.2.0', '6.2.5'], ['6.2.7', '6.4.1'], ['6.4.3', '']], 'type': 'int'},
                'version': {'v_range': [['6.2.0', '6.2.5'], ['6.2.7', '6.4.1'], ['6.4.3', '']], 'type': 'int'}
            }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_config_reset_database'),
