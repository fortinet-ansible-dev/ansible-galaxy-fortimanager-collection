...
DOCUMENTATION = '''
---
module: fmgr_spamfilter_profile_imap
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/spamfilter/profile/{profile}/imap/{imap}',
        '/pm/config/global/obj/spamfilter/profile/{profile}/imap/{imap}'
    ]
    ...
    module_arg_spec = {
        ...
        'spamfilter_profile_imap': {
            ...
            'v_range': [['6.0.0', '7.2.1']],
            'options': {
                'action': {'v_range': [['6.0.0', '7.2.1']], 'choices': ['pass', 'tag'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'spamfilter_profile_imap'),
