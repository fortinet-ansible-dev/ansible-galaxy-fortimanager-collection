...
DOCUMENTATION = '''
---
module: fmgr_dlp_label_entries
short_description: DLP label entries.
description:
...
options:
    ...
    adom:
        ...
        required: true
    label:
        description: The parameter (label) in requested url.
        type: str
        required: true
    dlp_label_entries:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dlp_label_entries'),
