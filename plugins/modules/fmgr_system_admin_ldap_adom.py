...
DOCUMENTATION = '''
---
module: fmgr_system_admin_ldap_adom
short_description: Admin domain.
description:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_admin_ldap_adom': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'adom-name': {'required': True, 'type': 'str'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_admin_ldap_adom'),
