...
DOCUMENTATION = '''
---
module: fmgr_extensioncontroller_extenderprofile_cellular_modem2
        ...
        suboptions:
            auto-switch:
                ...
                suboptions:
                    ...
                    switch-back-time:
                        type: str
                        description: Deprecated, please rename it to switch_back_time. Automatically switch over to preferred SIM/carrier at a specifie...
                    switch-back-timer:
                        type: int
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/extension-controller/extender-profile/{extender-profile}/cellular/modem2/{modem2}',
        '/pm/config/global/obj/extension-controller/extender-profile/{extender-profile}/cellular/modem2/{modem2}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extensioncontroller_extenderprofile_cellular_modem2'),
