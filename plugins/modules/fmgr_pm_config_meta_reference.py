    ...
    pm_config_meta_reference:
        ...
        suboptions:
            package list:
                type: list
                elements: dict
                description: Deprecated, please rename it to package_list. Package list.
                suboptions:
                    name:
                        type: str
                        description: Name.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/_meta/reference/{reference}',
        '/pm/config/global/_meta/reference/{reference}'
    ]
