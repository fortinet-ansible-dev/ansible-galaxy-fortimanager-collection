  ...
  tasks:
    - name: no description
      fmgr_firewall_casbprofile_saasapplication_customcontrol_option:
        ...
        rc_failed: [-2, -3, ...]
        adom: <your own value>
        casb-profile: <your own value>
        saas-application: <your own value>
        custom-control: <your own value>
        state: <value in [present, absent]>
        firewall_casbprofile_saasapplication_customcontrol_option:
          name: <string>
          user-input: <list or string>
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/firewall/casb-profile/{casb-profile}/saas-application/{saas-application}/custom-control/{custom-control}/option/{option}',
        '/pm/config/global/obj/firewall/casb-profile/{casb-profile}/saas-application/{saas-application}/custom-control/{custom-control}/option/{option}'
    ]

    url_params = ['adom', 'casb-profile', 'saas-application', 'custom-control']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_casbprofile_saasapplication_customcontrol_option'),
