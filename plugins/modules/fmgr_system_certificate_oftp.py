...
options:
    ...
    system_certificate_oftp:
        ...
        suboptions:
            ...
            private-key:
                type: raw
                description: (list) Deprecated, please rename it to private_key. PEM format private key.
            local:
                type: str
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/certificate/oftp/{oftp}'
    ]
    ...
    module_arg_spec = {
        'system_certificate_oftp': {
            ...
            'options': {
                ...
                'local': {'v_range': [['6.2.5', '6.2.12'], ['6.4.1', '']], 'type': 'str'},
                'mode': {'v_range': [['6.2.5', '6.2.12'], ['6.4.1', '']], 'choices': ['default', 'custom', 'local'], 'type': 'str'}
            }
