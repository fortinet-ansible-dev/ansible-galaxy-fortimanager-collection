...
short_description: Configuration method to edit Simple Network Management Protocol (SNMP) system info.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Configuration method to edit Simple Network Management Protocol (SNMP) system info.
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/switch-controller/managed-switch/{managed-switch}/snmp-sysinfo/{snmp-sysinfo}',
        '/pm/config/adom/{adom}/obj/switch-controller/managed-switch/{managed-switch}/snmp-sysinfo/{snmp-sysinfo}'
    ]
