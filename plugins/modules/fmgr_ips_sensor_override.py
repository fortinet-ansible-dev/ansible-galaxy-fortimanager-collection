...
DOCUMENTATION = '''
---
module: fmgr_ips_sensor_override
short_description: IPS override rule.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ips_sensor_override'),
