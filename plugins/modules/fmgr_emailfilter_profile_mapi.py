...
DOCUMENTATION = '''
---
module: fmgr_emailfilter_profile_mapi
short_description: MAPI.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/emailfilter/profile/{profile}/mapi/{mapi}',
        '/pm/config/adom/{adom}/obj/emailfilter/profile/{profile}/mapi/{mapi}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'emailfilter_profile_mapi'),
