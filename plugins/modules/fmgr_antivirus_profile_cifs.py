...
DOCUMENTATION = '''
---
module: fmgr_antivirus_profile_cifs
short_description: Configure CIFS AntiVirus options.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/global/obj/antivirus/profile/{profile}/cifs/{cifs}',
        '/pm/config/adom/{adom}/obj/antivirus/profile/{profile}/cifs/{cifs}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'antivirus_profile_cifs'),
