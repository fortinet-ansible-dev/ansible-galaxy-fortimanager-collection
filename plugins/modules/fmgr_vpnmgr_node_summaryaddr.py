...
options:
    ...
    adom:
        ...
        required: true
    node:
        description: The parameter (node) in requested url.
        type: str
        required: true
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpnmgr_node_summaryaddr': {
            'type': 'dict',
            'v_range': [['6.0.0', '']],
            'options': {'addr': {'type': 'str'}, 'priority': {'type': 'int'}, 'seq': {'required': True, 'type': 'int'}}
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnmgr_node_summaryaddr'),
