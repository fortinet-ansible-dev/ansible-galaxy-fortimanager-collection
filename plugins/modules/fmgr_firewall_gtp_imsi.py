...
DOCUMENTATION = '''
---
module: fmgr_firewall_gtp_imsi
short_description: IMSI.
description:
    ...
    firewall_gtp_imsi:
        ...
        suboptions:
            ...
            selection-mode:
                type: list
                elements: str
                description: Deprecated, please rename it to selection_mode.
                choices:
                    - 'ms'
                    - 'net'
                    - 'vrf'
...
- name: Gathering fortimanager facts
  ...
  vars:
    ...
    ansible_httpapi_port: 443
  tasks:
    - name: Retrieve all the IMSIs in the GTP
      fortinet.fortimanager.fmgr_fact:
        facts:
          selector: "firewall_gtp_imsi"
          params:
            adom: "FortiCarrier" # This is FOC-only object, need a FortiCarrier adom
            gtp: "ansible-test" # name
            imsi: "your_value"
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_gtp_imsi'),
