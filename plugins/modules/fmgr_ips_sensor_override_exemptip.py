...
DOCUMENTATION = '''
---
module: fmgr_ips_sensor_override_exemptip
short_description: Exempted IP.
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: Exempted IP.
      fmgr_ips_sensor_override_exemptip:
...
def main():
    ...
    url_params = ['adom', 'sensor', 'override']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ips_sensor_override_exemptip'),
