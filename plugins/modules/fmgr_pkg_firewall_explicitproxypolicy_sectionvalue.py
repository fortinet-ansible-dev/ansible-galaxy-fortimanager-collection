...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_explicitproxypolicy_sectionvalue
...
options:
    ...
    explicit_proxy_policy:
        ...
        type: str
    pkg_firewall_explicitproxypolicy_sectionvalue:
...
def main():
    urls_list = [
        '/pm/config/adom/{adom}/pkg/{pkg}/firewall/explicit-proxy-policy/{explicit-proxy-policy}/section value'
    ]
    ...
    module_arg_spec = {
        ...
        'pkg_firewall_explicitproxypolicy_sectionvalue': {
            ...
            'options': {
                'attr': {'v_range': [['6.2.0', '6.2.13']], 'choices': ['label', 'global-label'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_explicitproxypolicy_sectionvalue'),
