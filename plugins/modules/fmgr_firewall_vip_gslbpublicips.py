...
DOCUMENTATION = '''
---
module: fmgr_firewall_vip_gslbpublicips
short_description: Publicly accessible IP addresses for the FortiGSLB service.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Publicly accessible IP addresses for the FortiGSLB service.
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_vip_gslbpublicips'),
