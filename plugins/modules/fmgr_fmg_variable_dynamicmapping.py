...
options:
    ...
    adom:
        ...
        required: true
    variable:
        description: The parameter (variable) in requested url.
        type: str
        required: true
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'fmg_variable_dynamicmapping'),
