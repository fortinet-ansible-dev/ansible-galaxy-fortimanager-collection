...
DOCUMENTATION = '''
---
module: fmgr_system_log_ratelimit_device
...
def main():
    ...
    module_arg_spec = {
        'system_log_ratelimit_device': {
            ...
            'options': {
                ...
                'id': {'v_range': [['6.4.8', '7.0.2']], 'required': True, 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_log_ratelimit_device'),
