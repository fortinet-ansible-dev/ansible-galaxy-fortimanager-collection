...
DOCUMENTATION = '''
---
module: fmgr_system_locallog_syslogd2_filter
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/locallog/syslogd2/filter/{filter}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_locallog_syslogd2_filter'),
