...
DOCUMENTATION = '''
---
module: fmgr_extendercontroller_extenderprofile_cellular_modem2
...
def main():
    ...
    perobject_jrpc_urls = [
        '/pm/config/adom/{adom}/obj/extender-controller/extender-profile/{extender-profile}/cellular/modem2/{modem2}',
        '/pm/config/global/obj/extender-controller/extender-profile/{extender-profile}/cellular/modem2/{modem2}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extenderprofile_cellular_modem2'),
