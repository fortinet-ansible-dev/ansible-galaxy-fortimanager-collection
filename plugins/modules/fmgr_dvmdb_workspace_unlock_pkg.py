...
DOCUMENTATION = '''
---
module: fmgr_dvmdb_workspace_unlock_pkg
short_description: Unlock a specific package, where the url includes both the folder(s) and name of the policy package.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'dvmdb_workspace_unlock_pkg'),
