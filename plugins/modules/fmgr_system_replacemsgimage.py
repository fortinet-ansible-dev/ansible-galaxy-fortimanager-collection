...
DOCUMENTATION = '''
---
module: fmgr_system_replacemsgimage
...
options:
    ...
    system_replacemsgimage:
        ...
        suboptions:
            image-base64:
                type: str
                description: Deprecated, please rename it to image_base64. Image data.
            image-type:
                type: str
                description: Deprecated, please rename it to image_type. Image type.
                choices:
                    - 'gif'
                    - 'jpg'
                    - 'tiff'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsgimage'),
