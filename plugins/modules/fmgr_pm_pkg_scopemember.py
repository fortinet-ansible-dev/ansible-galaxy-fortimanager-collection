...
DOCUMENTATION = '''
---
module: fmgr_pm_pkg_scopemember
...
def main():
    urls_list = [
        '/pm/pkg/adom/{adom}/{pkg_path}/scope member',
        '/pm/pkg/global/{pkg_path}/scope member'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pm_pkg_scopemember'),
